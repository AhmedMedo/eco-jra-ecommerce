        ...
        <div class="col-lg-6 mx-auto">
            <div class="card mb-30">
                <div class="card-header bg-white border-bottom2 py-3">
                    <h4 class="mb-1">{{ translate('New Language') }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('core.language.new.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-row mb-20">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="native_name" class="theme-input-style"
                                    value="{{ old('native_name') }}" placeholder="{{ translate('Type  Native Name') }}">
