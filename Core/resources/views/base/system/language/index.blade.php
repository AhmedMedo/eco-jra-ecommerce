        ...
        <div class="col-12">
            <div class="card mb-30">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('core.language.new') }}" class="btn long">{{ translate('Add New Language') }}</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="languageTable" class="hoverable text-nowrap border-top2">
                            <thead>
                                <tr>
                                    <th>#</th>
                                        ...
                                        <td>
                                            <div class="dropdown-button">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a
                                                        href="{{ route('core.language.frontend.translations', $lang->id) }}">
        ...
        (function($) {
            ...
            $(function() {
                $("#languageTable").DataTable({
                    ...
                    "lengthChange": true,
                    "autoWidth": false,
                }).buttons().container().appendTo('#languageTable_wrapper .col-md-6:eq(0)');
            });
            /**
             * 
