...
@section('main_content')
    <div class="theme-option-container">
        @include('core::base.business.includes.header', ['sub_link' => 'Email Templates'])
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active">
                    ...
                    @foreach ($admin_email_templates as $key => $templates)
                        ...
                        <div class="card-header bg-white border-bottom2 {{ $key > 0 ? 'border-top2' : '' }} py-3">
                            <h4>{{ $template_name }} Teamplates</h4>
                        </div>
    ...
    < @endsection @section('custom_scripts') <script src="https://unpkg.com/ace-builds@1.6.0/src-min-noconflict/ace.js" type="text/javascript" charset="utf-8">
    </script>
    <script src="{{ asset('web-assets/backend/plugins/js-beautify/beautify-html.js') }}"></script>
    <script>
        /**
        ...
        function logoAndFooter(content) {
            "use strict";
            let system_logo = "{{ asset(getFilePath(getGeneralSetting('admin_logo'), true)) }}"
