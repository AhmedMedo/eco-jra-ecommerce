...
<script src="{{ asset('web-assets/backend/plugins/dropzone/dropzone.min.js') }}"></script>
<!-- ======= BEGIN GLOBAL MANDATORY SCRIPTS ======= -->
...
<!-- ======= TOASTER ======= -->
<script src="{{ asset('web-assets/backend/js/toaster.min.js') }}"></script>
{!! Toastr::message() !!}
<!-- ======= TOASTER ======= -->
...
<script>
    ...
    function removeSelection(ids) {
        ...
        $(rmoveableIds[0]).attr('src', '{{ getPlaceHolderImagePath() }}')
        $(rmoveableIds[1]).val('')
        $(rmoveableIds[2]).hide()
    }
