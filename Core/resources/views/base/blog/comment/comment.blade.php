    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-30">
                <div class="d-sm-flex justify-content-between align-items-center bg-white card-header py-3">
                    <h4 class="font-20">
                        {{ translate('Comments') }}
                        @if (request()->blog)
                            @php
                                        ...
                                        <td class="d-flex align-itmes-center vtop">
                                            @php
                                                ...
                                                if ($comment->user_type == 'customer') {
                                                    $author = Plugin\Ecommerce\Models\Customers::where('id', $comment->user_id)->first();
                                                }
                                            ...
                                            <div class="d-inline">
                                                <img src="
                                                    ...
                                                    @endif"
                                                    alt="author image" class="comment_img">
                                            </div>
