        ...
        <div class="col-md-12">
            <div class="card mb-30">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <h4 class="font-20">{{ translate('All Blogs') }}</h4>
                    @can('Create Blog')
                        <div class="d-flex flex-wrap">
                            <a href="{{ route('core.add.blog') }}" class="btn long">{{ translate('Write New Blog') }}</a>
                        </div>
                    @endcan
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($blogs as $blog)
                                    <tr>
                                        ...
                                        @endcan
                                        <td>
                                            <img src="{{ asset(getFilePath($blog->image, true)) }}" class="w-75"
                                                alt="{{ $blog->permalink }}">
                                        </td>
                                        <td>
                                            <span class="blog-title">
                                                ...
                                                @else
                                                    <a href="/blog-preview?name={{ $blog->permalink }}"
                                                        target="_blank">{{ strlen($blog_name) > 35 ? mb_substr($blog_name, 0, 35, 'UTF-8') . '...' : $blog_name }}</a>
                                                @endif
                                            </span>
                                        </td>
                                        ...
                                        @can('Manage Comment')
                                            <td>
                                                <a href="{{ route('core.blog.comment') . '?status=singel_blog_comment&blog=' . $blog->id }}"
                                                    ...
                                                    <span class="count"
                                                        data-bg-img="{{ asset('web-assets/backend/img/count-bg.png') }}">
                                                        {{ getCommentCount([['tl_blog_comments.blog_id', '=', $blog->id], ['tl_blog_comments.status', '=', '1']]) }}
                                                    </span>
                                                    <img src="{{ asset('web-assets/backend/img/svg/message-icon.svg') }}"
                                                        alt="" class="svg">
                                                </a>
                                            </td>
                                        @endcan
