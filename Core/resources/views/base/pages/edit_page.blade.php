            ...
            <div class="col-md-8">
                ...
                <div class="card mb-30">
                    <div class="card-body">
                        ...
                        {{-- Content Field --}}
                        <div
                            class="form-group row my-4 {{ isActivePlugin('pagebuilder') && $page->page_type == 'builder' ? 'd-none' : '' }}">
            ...
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-12 @if (!empty($lang) && $lang != getdefaultlang()) area-disabled @endif">
                        ...
                        {{-- Featured Image --}}
                        <div
                            class="card  page_image {{ isActivePlugin('pagebuilder') && $page->page_type == 'builder' ? 'd-none' : '' }}">
                            <div class="card-header bg-white py-3">
