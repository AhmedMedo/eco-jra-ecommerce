...
Route::group(['middleware' => 'auth'], function () {
    Route::get('/dashboard', [DashboardController::class, 'dashboard'])
        ->name('admin.dashboard')->middleware(['can:Manage Dashboard', 'vhost']);
     ...
     * 
     */
    Route::middleware(['can:Manage Language', 'vhost'])->group(function () {
    ...
    Route::group(['prefix' => 'business'], function () {
        //General Settings
        Route::middleware(['can:Manage General Settings', 'vhost'])->group(function () {
        ...
        //Media Settings
        Route::middleware(['can:Manage Media Settings', 'vhost'])->group(function () {
        ...
        //Email SMTP settings
        Route::middleware(['can:Manage Email Settings', 'vhost'])->group(function () {
        ...
        //Email template
        Route::middleware(['can:Manage Email Templates', 'vhost'])->group(function () {
         ...
         * Seo settings
         */
        Route::middleware(['can:Manage Seo Settings', 'vhost'])->group(function () {
     ...
     * Plugins Management
     */
    Route::middleware(['can:Manage Plugins', 'vhost'])->group(function () {
        //plugins
    ...
    //Themes
    Route::middleware(['can:Manage Themes', 'vhost'])->group(function () {
    ...
    //Menu controller
    Route::middleware(['can:Manage Menus', 'menu.maintain', 'vhost'])->group(function () {
    ...
    //Activity Log
    Route::middleware(['can:Manage Login activity', 'vhost'])->group(function () {
    ...
    Route::controller(BlogCategoryController::class)->group(function () {
        Route::middleware(['can:Manage Category', 'vhost'])->group(function () {
    ...
    Route::controller(TagController::class)->group(function () {
        Route::middleware(['can:Manage Tag', 'vhost'])->group(function () {
    ...
    Route::controller(BlogController::class)->group(function () {
        Route::get('/blog-list', 'blog')->name('core.blog')->middleware(['can:Show Blog', 'vhost']);
        Route::get('/add-blog', 'addBlog')->name('core.add.blog')->middleware(['can:Create Blog', 'vhost']);
        Route::post('/store-blog', 'storeBlog')->name('core.store.blog')->middleware(['can:Create Blog', 'vhost'])->middleware('demo');
        Route::get('/edit-blog/{id}', 'editBlog')->name('core.edit.blog')->middleware(['can:Edit Blog', 'vhost']);
        Route::post('/update-blog', 'updateBlog')->name('core.update.blog')->middleware(['can:Edit Blog', 'vhost'])->middleware('demo');
        Route::post('/blog/delete', 'deleteBlog')->name('core.delete.blog')->middleware(['can:Delete Blog', 'vhost'])->middleware('demo');
        Route::post('/blog/bulk-delete', 'bulkDeleteBlog')->name('core.bulk.delete.blog')->middleware(['can:Delete Blog', 'vhost'])->middleware('demo');
        Route::post('/blog/featured-status-update', 'updateBlogFeaturedStatus')->name('core.update.blog.featured.status', 'vhost')->middleware(['can:Edit Blog', 'demo']);
    ...
    Route::controller(CommentController::class)->group(function () {
        Route::middleware(['can:Manage Comment', 'vhost'])->group(function () {
    ...
    Route::controller(PageController::class)->group(function () {
        Route::get('/page-list', 'page')->name('core.page')->middleware(['can:Show Page', 'vhost']);
        Route::get('/add-page', 'addPage')->name('core.page.add')->middleware(['can:Create Page', 'vhost']);
        Route::post('/store-page', 'storePage')->name('core.page.store')->middleware(['can:Create Page', 'vhost'])->middleware('demo');
        Route::get('/edit-page', 'editPage')->name('core.page.edit')->middleware(['can:Edit Page', 'vhost']);
        Route::post('/update-page', 'updatePage')->name('core.page.update')->middleware(['can:Edit Page', 'vhost'])->middleware('demo');
        Route::post('/page/delete', 'deletePage')->name('core.page.delete')->middleware(['can:Delete Page', 'vhost'])->middleware('demo');
        Route::post('/page/bulk-delete', 'bulkDeletePage')->name('core.bulk.delete.page')->middleware(['can:Delete Page', 'vhost'])->middleware('demo');
        Route::post('/page-change-status', 'pageStatusChange')->name('core.page.status.change')->middleware(['can:Edit Page', 'vhost']);
        ...
        Route::get('/page-make-homepage/{page}', 'makeHomepage')->name('core.page.make.homepage')->middleware(['can:Manage Page Builder', 'vhost'])->middleware('demo');
    });
    //----Blog & page End----//
    ...
    Route::group(['prefix' => 'backup'], function () {
        //Project backup
        Route::get('files', [BackupController::class, 'filesBackup'])->name('core.backup.files.list')->middleware(['can:Manage Backups', 'vhost']);
        Route::get('generate-backup-file', [BackupController::class, 'fileBackupGenerate'])->name('core.backup.files.generate')->middleware(['demo', 'can:Manage Backups', 'vhost']);
        Route::post('delete-backup-file', [BackupController::class, 'fileBackupDelete'])->name('core.backup.files.delete')->middleware(['demo', 'can:Manage Backups', 'vhost']);
        Route::get('download-backup-file/{filename}', [BackupController::class, 'fileBackupDownload'])->name('core.backup.files.download')->middleware(['demo', 'can:Manage Backups', 'vhost']);
        //Database backup
        Route::get('database', [BackupController::class, 'databaseBackup'])->name('core.backup.database.list')->middleware(['can:Manage Backups', 'vhost']);
        Route::get('generate-database-backup', [BackupController::class, 'databaseBackupGenerate'])->name('core.backup.database.generate')->middleware(['demo', 'can:Manage Backups', 'vhost']);
        Route::get('download-backup-database/{filename}', [BackupController::class, 'databaseBackupDownload'])->name('core.backup.database.download')->middleware(['demo', 'can:Manage Backups', 'vhost']);
        Route::post('delete-backup-database', [BackupController::class, 'databaseBackupDelete'])->name('core.backup.database.delete')->middleware(['demo', 'can:Manage Backups', 'vhost']);
    });
    ...
    Route::group(['prefix' => 'system'], function () {
        Route::middleware(['can:Manage Update', 'vhost'])->group(function () {
    ...
    Route::group(['prefix' => 'license'], function () {
        Route::middleware(['can:Manage Update'])->group(function () {
            Route::get('/', [SystemController::class, 'licenseList'])->name('app.system.license.list');
            Route::post('/', [SystemController::class, 'licenseRemove'])->name('app.system.license.remove')->middleware('demo');
        });
    });
