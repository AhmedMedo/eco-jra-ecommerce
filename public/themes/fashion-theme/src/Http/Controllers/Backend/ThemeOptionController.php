...
use Theme\FashionTheme\Repositories\ThemeOptionRepository;
...
class ThemeOptionController extends Controller
{
    ...
    {
        try {
            return view('theme/fashion-theme::backend.theme.options');
        } catch (\Exception $e) {
    ...
    public function getOptionForm(Request $request)
    {
        try {
            ...
            $form = view('theme/fashion-theme::backend.theme.option-form.' . $option_name, compact('option_settings'))->render();
