...
<form action="#" class=" widget_input_field_form px-3 py-3 bg-white"
    ...
    <div class="form-group">
        ...
        <textarea id="newsletter_short_desc" name="newsletter_short_desc" class="theme-input-style style--two"
            placeholder="{{ translate('Newsletter Short Desc') }}">{{ $newsletter_short_desc }}</textarea>
    </div>
