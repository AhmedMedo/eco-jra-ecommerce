            ...
            <div class="col-4">
                <div class="input-group">
                    ...
                    <label for="full_layout">
                        <img src="{{ asset('/themes/fashion-themeblog/images/layout/no-sideber.png') }}"
            ...
            <div class="col-4">
                <div class="input-group">
                    ...
                    <label for="left_sidebar_layout">
                        <img src="{{ asset('/themes/fashion-themeblog/images/layout/left-sideber.png') }}"
            ...
            <div class="col-4">
                <div class="input-group">
                    ...
                    <label for="right_sidebar_layout">
                        <img src="{{ asset('/themes/fashion-themeblog/images/layout/right-sideber.png') }}"
            ...
            <div class="col-4">
                <div class="input-group">
                    ...
                    <label for="col-lg-12-col-12">
                        <img src="{{ asset('/themes/fashion-themeblog/images/layout/1column.png') }}"
            ...
            <div class="col-4">
                <div class="input-group">
                    ...
                    <label for="col-lg-6-col-6">
                        <img src="{{ asset('/themes/fashion-themeblog/images/layout/2column.png') }}"
            ...
            <div class="col-4">
                <div class="input-group">
                    ...
                    <label for="col-lg-4-col-6">
                        <img src="{{ asset('/themes/fashion-themeblog/images/layout/3column.png') }}"
