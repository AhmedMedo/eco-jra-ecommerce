...
class FashlyBase
{
	public $key = "38511D6F2CD0D094";
	private $product_id = "78";
	private $product_base = "fashly";
	private $server_host = "https://themelooks.com/wp-json/licensor/";
	/* @var self*/
			...
			if (!empty($response->status)) {
				if (!empty($response->data)) {
					...
					if ($licenseObj->is_valid) {
						...
						$responseObj->email = $admin_email;
						$responseObj->version = $app_version;
