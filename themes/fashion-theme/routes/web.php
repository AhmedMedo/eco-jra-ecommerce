...
if ($prefix == null || $prefix != getAdminPrefix()) {
    ...
    if (!isActivePlugin('ecommerce')) {
        throw new ThemeRequiredPluginException('Please Activate Ecommerce Plugin');
    }
...
Route::group(['middleware' => 'auth', 'prefix' => getAdminPrefix()], function () {
    // Widgets
    Route::middleware(['vhost',  'can:Manage Widget'])->group(function () {
    ...
    Route::middleware(['vhost',  'can:Manage Theme settings'])->group(function () {
        //Theme Options
