...
use Theme\FashionTheme\Http\Controllers\Api\HomePageController;
...
use Plugin\Ecommerce\Http\Controllers\LayoutSettingsController;
use Theme\FashionTheme\Http\Controllers\Frontend\NewsletterController;
use Theme\FashionTheme\Http\Controllers\Frontend\ThemeOptionController;
...
Route::group(['prefix' => 'theme/fashion-theme/v1'], function () {
