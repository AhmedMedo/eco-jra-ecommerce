...
namespace Theme\FashionTheme\Repositories;

use Illuminate\Support\Facades\DB;

use Theme\FashionTheme\Models\TlThemeOptionSettings;
...
class ThemeOptionRepository
{
    ...
    public function saveThemeOption($request)
    {
        ...
        switch ($option_name) {
            ...
            case 'custom_css':
                ...
                $path = base_path('/themes/fashion-themecss/custom_css.css');
                if (file_exists($path)) {
                    unlink($path);
                }
    ...
    public function setBlogStyle()
    {
        ...
        $path = base_path('themes/fashion-themecss/blog.css');
        setFolderPermissions($path);
    ...
    public function setSidebarOptionStyle()
    {
        ...
        $path = base_path('themes/fashion-themecss/sidebar_options.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function set404PageStyle()
    {
        ...
        $path = base_path('themes/fashion-themecss/page_404.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setFooterStyle()
    {
        ...
        $path = base_path('themes/fashion-themecss/footer.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setBackToTopStyle()
    {
        ...
        $path = base_path('themes/fashion-themecss/back_to_top.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    /**
    ...
    public function setSocialIconStyle()
    {
        ...
        $path = base_path('themes/fashion-themecss/social_icon.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setHeaderOptionsStyle()
    {
        ...
        if (isset($style['custom_header']) && $style['custom_header'] == 1) {
            foreach ($style as $key => $value) {
                ...
                if ($key == 'header_mid_bg_color' && $value != "") {
                    $themeOption['.custom-header-mid']['background-color'] = $value . "!important;";
                }
                if ($key == 'header_mid_text_color' && $value != "") {
                    $themeOption['.custom-header-mid']['color'] = $value . "!important;";
                    $themeOption['.custom-header-mid .site-title']['color'] = $value . "!important;";
                }
                if ($key == 'sticky_header_bg_color' && $value != "") {
                    $themeOption['.custom-header-bottom.sticky']['background-color'] = $value . "!important;";
                }
                if ($key == 'sticky_header_text_color' && $value != "") {
                    $themeOption['.custom-header-bottom.sticky']['color'] = $value . "!important;";
                    $themeOption['.custom-header-bottom.sticky .site-title']['color'] = $value . "!important;";
                }
                ...
                if ($key == 'header_search_form_btn_color' && $value != "") {
                    ...
                    $themeOption['.search-form .input-group']['border-color'] = $value . "!important;";
                }
        ...
        $path = base_path('themes/fashion-themecss/header.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setHeaderLogosStyle()
    {
        ...
        $path = base_path('themes/fashion-themecss/header_logo.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setHeaderMenuStyle()
    {
        ...
        $path = base_path('themes/fashion-themecss/menu.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setNewsletterStyle()
    {
        ...
        $path = base_path('themes/fashion-themecss/subscribe.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function resetThemeOption($request)
    {
        ...
        if ($request->submitType == 'reset_section') {
            $path = base_path('themes/fashion-themecss/' . $request->option_name . '.css');
            if (file_exists($path)) {
                unlink($path);
            }
            fopen($path, 'w');
        ...
        if ($request->submitType == 'reset_all') {
            for ($i = 0; $i < sizeof($themeOptionCssFile); $i++) {
                $path = base_path('themes/fashion-themecss/' . $themeOptionCssFile[$i] . '.css');
                if (file_exists($path)) {
                    unlink($path);
                }
                fopen($path, 'w');
