...
class BlogController extends Controller
{
    ...
    public function getSingleBlogDetails($slug)
    {
        ...
        try {
            ...
            return view('theme/fashion-theme::frontend.pages.blog-details')->with(
                [
    ...
    public function loadBlogComment(Request $request)
    {
        try {
            ...
            $view = view('theme/fashion-theme::frontend.blog.includes.blog_comment', compact('blog_comments', 'blog'))->render();
            return response()->json([
                'success' => true,
                'view' => $view,
