...
use Theme\FashionTheme\Repositories\PageRepository;
...
class PagesController extends Controller
{
    ...
    {
        return view('theme/fashion-theme::frontend.pages.customer-login');
    }
    ...
    {
        return view('theme/fashion-theme::frontend.pages.customer-registration');
    }
    /**
     * seller registration
     */
    public function sellerRegistration()
    {
        ...
        return view('theme/fashion-theme::frontend.pages.seller-registration');
    }
    ...
    public function allShop()
    {
        ...
        return view('theme/fashion-theme::frontend.pages.home');
    }
    /**
    ...
    public function shopPage($slug)
    {
        ...
        return view('theme/fashion-theme::frontend.pages.shop', ['shopDetails' => $shopDetails]);
    }
    /**
    ...
    public function getSinglePageDetails(Request $request)
    {
        try {
            ...
            return view('theme/fashion-theme::frontend.pages.page-details')->with(
                [
