...
<head>
    ...
    @else
        <link rel="shortcut icon" href="{{ asset('web-assets/backend/img/favicon.png') }}">
    @endif
    ...
    <link rel="stylesheet" href="{{ asset('/themes/fashion-themecss/custom_app.css') }}">


    <link rel="stylesheet" type="text/css" href="{{ asset('/themes/fashion-themecss/back_to_top.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/themes/fashion-themecss/header.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/themes/fashion-themecss/header_logo.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/themes/fashion-themecss/menu.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/themes/fashion-themecss/blog.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/themes/fashion-themecss/sidebar_options.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/themes/fashion-themecss/page_404.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/themes/fashion-themecss/subscribe.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/themes/fashion-themecss/footer.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/themes/fashion-themecss/social_icon.css') }}">
...
<body class="antialiased">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/themes/fashion-themecss/custom_css.css') }}">
    <script>
        //set site title
    ...
    @if (isActivePlugin('ecommerce'))
        <script src="{{ asset('/themes/fashion-theme/public/js/main.js?v=1023') }}"></script>
    @endif
