...
@section('custom_css')
    ...
    <link rel="stylesheet" href="{{ asset('/themes/fashion-themeblog/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('/themes/fashion-themeblog/dist/css/fontawesome-iconpicker.min.css') }}">
    {{-- Jqueey UI CSS --}}
...
@section('main_content')
    ...
    <div class="theme-option-container">
        <form action="{{ route('theme.fashion-theme.save.option.form') }}" method="post" enctype="multipart/form-data"
            id="themeOptionForm">
            @csrf
            ...
            <div class="theme-option-tab-wrap">
                <div class="nav flex-column py-3 px-2 theme-option-sidebar" aria-orientation="vertical">
                    @includeIf('theme/fashion-theme::backend.theme.option_sidebar')
                </div>
...
@section('custom_scripts')
    ...
    <!--End Select2-->
    {{-- Jqueey UI Js --}}
    <script src="{{ asset('web-assets/backend/plugins/jquery-ui/jquery-ui.js') }}"></script>

    {{-- Fontawesome iconpicker js --}}
    <script src="{{ asset('/themes/fashion-themeblog/dist/js/fontawesome-iconpicker.min.js') }}"></script>
    ...
    {{-- Cookies Js --}}
    <script src="{{ asset('web-assets/backend/plugins/js-cookie/js.cookie.min.js') }}"></script>
    ...
    <script  type="application/javascript">
        ...
        function getOptionForm(id){
            ...
            $.ajax({
                type: "post",
                url: '{{ route('theme.fashion-theme.get.option.form') }}',
                data: {
                    id: id
                },
