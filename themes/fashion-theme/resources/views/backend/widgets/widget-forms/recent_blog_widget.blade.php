...
<form action="#" class=" widget_input_field_form px-3 py-3 bg-white"
    ...
    <div class="form-group @if (!empty($lang) && $lang != getdefaultlang()) area-disabled @endif">
        ...
        <input type="number" class="form-control" id="number_of_recent_blog" name="number_of_recent_blog"
            placeholder="{{ translate('Number of Recent Blog') }}" value="{{ $number_of_recent_blog }}"
