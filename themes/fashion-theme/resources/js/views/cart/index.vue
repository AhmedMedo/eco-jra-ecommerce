        ...
        <div class="row" v-if="!dataLoading">
          ...
          <div class="col-lg-8 col-12" v-if="tableData.length">
            <div class="shadow-card">
                    ...
                    <div class="col-lg-10 col-8">
                      <div class="row">
                        <div class="col-12 col-lg-8 description px-0">
                          ...
                          <p class="mb-1 product-price fz-sm-12 c1">
                            <the-currency
              ...
              <div class="d-none d-lg-block mt-3 col-12 d-lg-flex flex-wrap">
                <p
          ...
          <div class="col-12 text-center" v-if="!tableData.length">
            <img
              src="/public/web-assets/frontend/themes/fashion-theme/assets/img/empty-cart.png"
              alt="empty-cart"
