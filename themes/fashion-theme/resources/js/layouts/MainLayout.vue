...
export default {
  ...
  methods: {
    ...
    getAllMenusForEcommerceHome() {
      ...
      axios
        .get("/api/theme/fashion-theme/v1/get-all-menus-for-ecommerce-home", {
          headers: headers,
        })
        .then((response) => {
          if (response.data.success) {
    ...
    getFooterWidget() {
      ...
      axios
        ...
        .get("/api/theme/fashion-theme/v1/get-footer-widgets", {
          headers: headers,
        })
        .then((response) => {
          if (response.data.success) {
    ...
    getThemeStyle() {
      ...
      axios
        .get("/api/theme/fashion-theme/v1/get-theme-style", {
          headers: headers,
        })
        .then((response) => {
          if (response.data.success) {
