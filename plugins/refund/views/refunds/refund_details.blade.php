                    ...
                    <div class="col-xl-3 col-md-6 mb-30">
                        <div class="invoice payment-details mt-5 mt-xl-0">
                            ...
                            @if ($details->customer != null)
                                <ul class="status-list">
                                    <li>
                                        <a href="{{ route('plugin.ecommerce.customers.details', ['id' => $details->customer->id]) }}"
                ...
                <div class="card-body">
                    <div class="row px-12">
                        ...
                        <div class="col-md-12 mb-20">
                            <!--steps-->
                            @if ($details->return_status != config('ecommerce.return_request_status.cancelled'))
                                <div class="order-status-range">
                                    <ul class="progressbar d-flex">
                                        <li
                                            class="{{ $details->return_status == config('ecommerce.return_request_status.pending') || $details->return_status == config('ecommerce.return_request_status.processing') || $details->return_status == config('ecommerce.return_request_status.product_received') || $details->return_status == config('ecommerce.return_request_status.approved') || $details->return_status == config('ecommerce.return_request_payment_status.refunded') ? 'active' : '' }}">
                                            @if ($details->return_status == config('ecommerce.return_request_status.pending'))
                                                {{ translate('Pending') }}
                                            @else
                                                {{ $details->return_status == config('ecommerce.return_request_status.processing') ? translate('Processing') : translate('Product Received') }}
                                            @endif
                                        </li>

                                        <li
                                            class="{{ $details->return_status == config('ecommerce.return_request_status.approved') ? 'active' : '' }}">
                                            {{ translate('Return Approved') }}
                                        </li>
                                        <li
                                            class="{{ $details->refund_status == config('ecommerce.return_request_payment_status.refunded') ? 'active' : '' }}">
                                            {{ translate('Refunded') }}
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row mb-20">
                            ...
                            <select class="theme-input-style" name="return_status" id="return_status">
                                <option value="{{ config('ecommerce.return_request_status.pending') }}"
                                    @selected($details->return_status == config('ecommerce.return_request_status.pending'))>
                                    {{ translate('Pending') }}
                                </option>
                                <option value="{{ config('ecommerce.return_request_status.processing') }}"
                                    @selected($details->return_status == config('ecommerce.return_request_status.processing'))>
                                    {{ translate('Processing') }}
                                </option>
                                <option value="{{ config('ecommerce.return_request_status.product_received') }}"
                                    @selected($details->return_status == config('ecommerce.return_request_status.product_received'))>
                                    {{ translate('Product Received') }}
                                </option>
                                <option value="{{ config('ecommerce.return_request_status.approved') }}"
                                    @selected($details->return_status == config('ecommerce.return_request_status.approved'))>
                                    {{ translate('Approved') }}
                                </option>
                                <option value="{{ config('ecommerce.return_request_status.cancelled') }}"
                                    @selected($details->return_status == config('ecommerce.return_request_status.cancelled'))>
                                    {{ translate('Cancelled') }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-row mb-20">
                            ...
                            <select class="theme-input-style payment_status" name="payment_status" id="payment_status">
                                <option value="{{ config('ecommerce.return_request_payment_status.pending') }}"
                                    @selected($details->refund_status == config('ecommerce.return_request_payment_status.pending'))>
                                    {{ translate('Pending') }}
                                </option>
                                <option value="{{ config('ecommerce.return_request_payment_status.refunded') }}"
                                    @selected($details->refund_status == config('ecommerce.return_request_payment_status.refunded'))>
                                    {{ translate('Refunded') }}
                                </option>
                            </select>
                        </div>
                        ...
                        <!--Amount-->
                        <div
                            class="form-row mb-20 refund-amount {{ $details->refund_status == config('ecommerce.return_request_payment_status.refunded') ? '' : 'd-none' }} ">
                            ...
                            <input type="text" name="refund_amount" id="amount" class="theme-input-style"
                                ...
                                @disabled($details->refund_status == config('ecommerce.return_request_payment_status.refunded'))>
                        </div>
                        <!--End amount-->
                        <!--Paid by-->
    ...
    <script>
        (function($) {
            ...
            $(".payment_status").on('change', function(e) {
                ...
                if (payment_status ==
                    {{ config('ecommerce.return_request_payment_status.refunded') }}) {
