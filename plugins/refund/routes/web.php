...
Route::group(['prefix' => getAdminPrefix()], function () {
    ...
    Route::group(['prefix' => 'refunds'], function () {
        //Configuration
        Route::get('/configuration', [RefundController::class, 'configuration'])->name('plugin.ecommerce.refunds.configuration');
        Route::post('/update-configuration', [RefundController::class, 'updateConfiguration'])->name('plugin.ecommerce.refunds.configuration.update')->middleware('demo');

        //Refund reasons
        Route::middleware(['vhost',  'can:Manage Refund reasons'])->group(function () {
        ...
        Route::middleware(['vhost',  'can:Manage Refund Requests'])->group(function () {
