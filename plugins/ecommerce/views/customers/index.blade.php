        ...
        <div class="col-12">
            <div class="card mb-30">
                ...
                <div class="px-2 filter-area d-flex align-items-center">
                    <form method="get" action="{{ route('plugin.ecommerce.customers.list') }}">
                    ...
                    <a class="btn btn-danger long mb-2"
                        href="{{ route('plugin.ecommerce.customers.list') }}">{{ translate('Clear Filter') }}</a>
                            ...
                            @if ($customers->count() > 0)
                                @foreach ($customers as $key => $customer)
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="{{ route('plugin.ecommerce.customers.details', ['id' => $customer->id]) }}">
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.ecommerce.customers.delete') }}">
                        @csrf
    ...
    <script>
        (function($) {
            ...
            $('.change-status').on('click', function(e) {
                ...
                $.post('{{ route('plugin.ecommerce.customers.change.status') }}', {
                    _token: '{{ csrf_token() }}',
                    id: id
                }, function(data) {
                    location.reload();
            ...
            $(".reset-password-btn").on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.customers.password.reset') }}',
            ...
            $(".update-customer").on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.customers.info.update') }}',
                    success: function(response) {
                        if (response.success) {
            ...
            $(".customer-secret-login").on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.customers.login.secret') }}',
                    success: function(response) {
                        if (response.success) {
