                                            ...
                                            <td>
                                                <div class="dropdown-button">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a
                                                            href="{{ route('plugin.ecommerce.ecommerce.settings.taxes.manage.rates', ['id' => $profile->id]) }}">
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST"
                        action="{{ route('plugin.ecommerce.ecommerce.settings.taxes.delete.profile') }}">
                        @csrf
        ...
        (function($) {
            ...
            $('.store-new-tax-profie-btn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.ecommerce.settings.taxes.store.profile') }}',
            ...
            $('.update-tax-profie-btn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.ecommerce.settings.taxes.update.profile') }}',
                    success: function(response) {
                        if (response.success) {
