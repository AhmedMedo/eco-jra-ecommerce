...
@section('main_content')
    <div class="align-items-center border-bottom2 d-flex flex-wrap gap-10 justify-content-between mb-4 pb-3">
        <h4><a href="{{ route('plugin.ecommerce.ecommerce.settings.taxes.list') }}" class="black"><i
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-30">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('plugin.ecommerce.ecommerce.update.zone.base.tax') }}">
                        @csrf
                ...
                <div class="modal-body">
                    <form id="new-tax-form">
                        ...
                        <div class="form-row mb-20 product-input">
                            ...
                            <div class="col-sm-12">
                                @php
                                    $products_collections = Plugin\Ecommerce\Models\ProductCollection::where('status', config('settings.general_status.active'))->get();
                                @endphp
                                ...
                                <p class="mt-2">{{ translate('You can select an existing collection or ') }}<a
                                        href="{{ route('plugin.ecommerce.product.collection.list') }}"
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.ecommerce.ecommerce.zone.tax.delete') }}">
                        @csrf
        ...
        (function($) {
            ...
            $('.store-tax-btn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.ecommerce.zone.tax.store') }}',
            ...
            $('.update-tax-btn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.ecommerce.zone.tax.update') }}',
                    success: function(response) {
                        location.reload();
                    },
                    error: function(response) {
            ...
            $('.bulk-action-apply-btn').on('click', function(e) {
                ...
                if (action === 'delete_all') {
                    ...
                    if (selected_items.length > 0) {
                        $.post('{{ route('plugin.ecommerce.ecommerce.zone.tax.delete.bulk') }}', {
                            _token: '{{ csrf_token() }}',
                            data: selected_items
                        }, function(data) {
                            location.reload();
