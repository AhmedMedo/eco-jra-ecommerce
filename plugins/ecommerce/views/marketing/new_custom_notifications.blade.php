            ...
            <div class="card mb-30">
                <div class="card-header border-bottom2 mb-20">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('plugin.ecommerce.marketing.custom.notification') }}"
                ...
                <div class="card-body">
                    <div>
                        <form action="{{ route('plugin.ecommerce.marketing.custom.notification.send') }}" method="POST">
                            @csrf
                            <div class="form-row mb-20">
                                ...
                                <div class="col-md-9">
                                    <select class="select-notification-user-type theme-input-style select-2" name="send_to">
                                        <option
                                            value="{{ config('ecommerce.custom_notification_receiver_type.all_customers') }}"
                                            @selected(old('send_to') == config('ecommerce.custom_notification_receiver_type.all_customers'))>
                                            {{ translate('All Customers') }}</option>
                                        <option
                                            value="{{ config('ecommerce.custom_notification_receiver_type.specific_customer') }}"
                                            @selected(old('send_to') == config('ecommerce.custom_notification_receiver_type.specific_customer'))>
                                            {{ translate('Specific Customers') }}</option>
                                        <option
                                            value="{{ config('ecommerce.custom_notification_receiver_type.all_users') }}"
                                            @selected(old('send_to') == config('ecommerce.custom_notification_receiver_type.all_users'))>
                                            {{ translate('All Users') }}</option>
                                        <option
                                            value="{{ config('ecommerce.custom_notification_receiver_type.specific_user') }}"
                                            @selected(old('send_to') == config('ecommerce.custom_notification_receiver_type.specific_user'))>
                                            {{ translate('Specific Users') }}
                                        </option>
                                        <option
                                            value="{{ config('ecommerce.custom_notification_receiver_type.specific_user_role') }}"
                                            @selected(old('send_to') == config('ecommerce.custom_notification_receiver_type.specific_user_role'))>
                            ...
                            <div
                                class="form-row mb-20 customer-selector {{ old('send_to') == config('ecommerce.custom_notification_receiver_type.specific_customer') ? '' : 'd-none' }}">
                                <div class="col-md-3">
                            ...
                            <div
                                class="form-row mb-20 user-selector {{ old('send_to') == config('ecommerce.custom_notification_receiver_type.specific_user') ? '' : 'd-none' }}">
                                <div class="col-md-3">
                            ...
                            <div
                                class="form-row mb-20 user-roles-selector {{ old('send_to') == config('ecommerce.custom_notification_receiver_type.specific_user_role') ? '' : 'd-none' }}">
                                <div class="col-md-3">
                            ...
                            <div class="form-row mb-20">
                                ...
                                <div class="col-md-9">
                                    <select class="select-notification-notification-type theme-input-style select-2"
                                        ...
                                        <option value="{{ config('ecommerce.custom_notification_type.dashboard') }}"
                                            @selected(old('notification_type') == config('ecommerce.custom_notification_type.dashboard'))>
                                            {{ translate('Dashboard') }}</option>
                                        <option value="{{ config('ecommerce.custom_notification_type.email') }}"
                                            @selected(old('notification_type') == config('ecommerce.custom_notification_type.email'))>
                                            {{ translate('Email') }}</option>
                                        <option value="{{ config('ecommerce.custom_notification_type.email_dashboard') }}"
                                            @selected(old('notification_type') == config('ecommerce.custom_notification_type.email_dashboard'))>
                            ...
                            <div
                                class="form-row mb-20 email-subject {{ old('notification_type') == config('ecommerce.custom_notification_type.email_dashboard') || old('notification_type') == config('ecommerce.custom_notification_type.email') ? '' : 'd-none' }}">
                                <div class="col-sm-3">
    ...
    <script>
        (function($) {
            ...
            $('.select-customers').select2({
                ...
                closeOnSelect: false,
                ajax: {
                    url: '{{ route('plugin.ecommerce.marketing.custom.notification.customer.options') }}',
                    dataType: 'json',
                    method: "GET",
                    delay: 250,
            ...
            $('.select-users').select2({
                ...
                closeOnSelect: false,
                ajax: {
                    url: '{{ route('plugin.ecommerce.marketing.custom.notification.users.options') }}',
                    dataType: 'json',
                    method: "GET",
                    delay: 250,
                    data: function(params) {
            ...
            $('.select-user-role').select2({
                ...
                closeOnSelect: false,
                ajax: {
                    url: '{{ route('plugin.ecommerce.marketing.custom.notification.user.roles.options') }}',
                    dataType: 'json',
                    method: "GET",
                    delay: 250,
                    data: function(params) {
            ...
            $(".select-notification-user-type").on('change', function(e) {
                ...
                if (type ==
                    {{ config('ecommerce.custom_notification_receiver_type.specific_customer') }}) {
                    $('.customer-selector').removeClass('d-none');
                    $('.user-selector').addClass('d-none');
                    $('.user-roles-selector').addClass('d-none');
                } else if (type ==
                    {{ config('ecommerce.custom_notification_receiver_type.specific_user') }}) {
                    $('.customer-selector').addClass('d-none');
                    $('.user-roles-selector').addClass('d-none');
                    $('.user-selector').removeClass('d-none');
                } else if (type ==
                    {{ config('ecommerce.custom_notification_receiver_type.specific_user_role') }}) {
                    $('.customer-selector').addClass('d-none');
                    $('.user-selector').addClass('d-none');
            ...
            $('.select-notification-notification-type').on('change', function(e) {
                ...
                let type = $(this).val();
                $('.select2-container--classic').addClass('w-100');
                if (type == {{ config('ecommerce.custom_notification_type.email') }} || type ==
                    {{ config('ecommerce.custom_notification_type.email_dashboard') }}) {
