@php
    if ($order_details->payment_method == config('ecommerce.payment_methods.bank')) {
        ...
        <div class="col-12">
            ...
            <div class="bg-white invoice-pd mb-30">
                <div class="row">
                    ...
                    @if (isActivePlugin('pickuppoint') && $order_details->pickup_point != null)
                        <div
                                    ...
                                    <div class="product-select-box">
                                        <label class="d-flex justify-content-between m-0 py-1">
                                            ...
                                            <input type="checkbox" class="order-product-id" value="{{ $product->id }}"
                                                @disabled($product->delivery_status == config('ecommerce.order_delivery_status.delivered')) data-item="{{ $product }}"
                                                name="product[]">
                                        </label>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.ecommerce.orders.item.cancel') }}">
                        @csrf
                        <input type="hidden" name="order_id" value="{{ $order_details->id }}">
                                    ...
                                    <div class="product-select-box">
                                        <label class="d-flex justify-content-between m-0 py-1">
                                            ...
                                            <input type="checkbox" class="invoice-product" value="{{ $product->id }}"
                                                @disabled($product->delivery_status == config('ecommerce.order_delivery_status.cancelled')) data-item="{{ $product }}"
    ...
    <script>
        (function($) {
            ...
            $('.update-order-status').on('click', function(e) {
                ...
                if (delivery_status == {{ config('ecommerce.order_delivery_status.delivered') }} &&
                    payment_status !=
                    {{ config('ecommerce.order_payment_status.paid') }}) {
                ...
                if (errors.length == 0) {
                    $.ajax({
                        ...
                        url: '{{ route('plugin.ecommerce.orders.status.update') }}',
