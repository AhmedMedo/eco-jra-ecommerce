    ...
    <div class="row">
        <div class="col-lg-7 mx-auto">
                        ...
                        @foreach ($languages as $key => $language)
                            <li class="nav-item">
                                <a class="nav-link @if ($language->code == $lang) active border-0 @else bg-light @endif py-3"
                                    href="{{ route('plugin.ecommerce.product.category.edit', ['id' => $category_details->id, 'lang' => $language->code]) }}">
            ...
            <div class="form-element py-30 mb-30">
                <form action="{{ route('plugin.ecommerce.product.category.update') }}" method="POST">
                    @csrf
                            ...
                            <select class="parentCategorySelect form-control" name="parent"
                                ...
                                @foreach ($categories as $category)
                                    ...
                                    @if (count($category->childs))
                                        @include('plugin/ecommerce::products.categories.child_category', [
