        ...
        <div class="col-12">
            <div class="card mb-30">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        @can('Manage Add New Product')
                            <div class="d-flex flex-wrap">
                                <a href="{{ route('plugin.ecommerce.product.add.new') }}"
                ...
                <div class="px-2 filter-area d-flex align-items-center">
                    <!--Filter area-->
                    <form method="get" action="{{ route('plugin.ecommerce.product.list') }}">
                    ...
                    @if (request()->has('search_key') || request()->has('payment_status'))
                        <a class="btn long btn-danger" href="{{ route('plugin.ecommerce.product.list') }}">
                    ...
                    <button class="btn long fire-bulk-action">{{ translate('Apply Bulk Action') }}
                    </button>
                    <!--End bulk actions-->
                </div>
