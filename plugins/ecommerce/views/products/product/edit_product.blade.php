@php
    $units = \Plugin\Ecommerce\Models\Units::with('unit_translations')
        ->orderBy('id', 'DESC')
        ->select('name', 'id')
        ->get();
    $conditions = \Plugin\Ecommerce\Models\ProductCondition::with('condition_translations')
        ->where('status', config('settings.general_status.active'))
        ->select('id', 'name')
        ->orderBy('id', 'DESC')
        ->get();

    $colors = \Plugin\Ecommerce\Models\Colors::where('status', config('settings.general_status.active'))
        ->select('id', 'name')
        ->orderBy('id', 'DESC')
        ->get();
    $languages = \Core\Models\Language::where('status', config('settings.general_status.active'))
        ...
        ->get();
    $attributes = \Plugin\Ecommerce\Models\ProductAttribute::with('attribute_translations')
        ->select('id', 'name', 'status')
        ->get();

    $cod_info = \Plugin\Ecommerce\Models\PaymentMethods::where('id', config('ecommerce.payment_methods.cod'))
        ->select(['status', 'id'])
        ->first();
    $is_active_cod = $cod_info != null ? $cod_info->status : config('settings.general_status.in_active');
    $tax_profiles = \Plugin\Ecommerce\Models\TaxProfile::where('status', config('settings.general_status.active'))
        ->select('id', 'title')
        ->get();
@endphp
...
@section('main_content')
    ...
    <form method="POST" class="row" enctype="multipart/form-data" id="product-form"
        action="{{ route('plugin.ecommerce.product.update') }}">
        @csrf
        <!--Left side-->
        <div class="col-lg-8">
            <div class="mb-3">
                ...
                @foreach ($languages as $key => $language)
                    <li class="nav-item">
                        <a class="nav-link @if ($language->code == $lang) active border-0 @else bg-light @endif py-3"
                            href="{{ route('plugin.ecommerce.product.edit', ['id' => $product_details->id, 'lang' => $language->code]) }}">
                        ...
                        <div class="d-flex d-sm-inline-flex align-items-center mr-sm-5 mb-3">
                            <div class="custom-radio mr-3">
                                <input type="radio" name="product_type" id="single_product"
                                    value="{{ config('ecommerce.product_variant.single') }}"
                                    @if ($product_details->has_variant == config('ecommerce.product_variant.single')) checked @endif
                        ...
                        <div class="d-flex d-sm-inline-flex align-items-center mr-sm-5 mb-3">
                            <div class="custom-radio mr-3">
                                <input type="radio" name="product_type" id="variant_product"
                                    value="{{ config('ecommerce.product_variant.variable') }}"
                                    @if ($product_details->has_variant == config('ecommerce.product_variant.variable')) checked @endif
            ...
            <!--Product Variation-->
            <div
                class="card mb-30 product-variation {{ $product_details->has_variant == config('ecommerce.product_variant.variable') ? '' : 'd-none' }} @if (!empty($lang) && $lang != getdefaultlang()) area-disabled @endif">
                <div class="card-header bg-white border-bottom2 py-3">
                    <div class="d-sm-flex justify-content-between align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-group d-flex">
                                                <select class="form-control choice-options-select"
                                                    ...
                                                    @php
                                                        $attribute_values = \Plugin\Ecommerce\Models\AttributeValues::where('attribute_id', $choice->choice_id)
                                                            ->where('status', config('settings.general_status.active'))
                                                            ->get();
                                                    @endphp
            ...
            <div class="card mb-30 @if (!empty($lang) && $lang != getdefaultlang()) area-disabled @endif">
                ...
                <div
                    class="card-body single-product-price {{ $product_details->has_variant == config('ecommerce.product_variant.single') ? '' : 'd-none' }}">
                    <div class="form-row mb-20">
                        <div class="col-sm-3">
                ...
                <div
                    class="variant-product-price {{ $product_details->has_variant == config('ecommerce.product_variant.variable') ? '' : 'd-none' }}">
                                            ...
                                            @php
                                                ...
                                                foreach ($variant_array as $com_key => $variant) {
                                                    ...
                                                    if ($variant_com_array[0] === 'color') {
                                                        ...
                                                        //Color Choice Option
                                                        $choice_details = \Plugin\Ecommerce\Models\Colors::find($variant_com_array[1]);
                                                        ...
                                                        //Choice
                                                        $choice_details = \Plugin\Ecommerce\Models\AttributeValues::find($variant_com_array[1]);
                                                        if ($choice_details != null) {
                ...
                <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-sm-4">
                                <select class="theme-input-style select2" name="discount_amount_type">
                                    <option value="{{ config('ecommerce.amount_type.flat') }}"
                                        @if ($product_details->discount_type == config('ecommerce.amount_type.flat')) selected @endif> {{ translate('Flat') }}
                                    </option>
                                    <option value="{{ config('ecommerce.amount_type.percent') }}"
                                        @if ($product_details->discount_type == config('ecommerce.amount_type.percent')) selected @endif> {{ translate('Percentage') }}
                                    </option>
                                </select>
                    ...
                    @if (getEcommerceSetting('enable_product_discount') != config('settings.general_status.active'))
                        <p class="mt-0 font-13">
                            ...
                            <a href="{{ route('plugin.ecommerce.ecommerce.configuration', ['tab' => 'products']) }}"
                    ...
                    @if (count($product_details->color_choices) > 0)
                        <div class="card-body">
                            @foreach ($product_details->color_choices as $key => $color)
                                @php
                                    $color_name = \Plugin\Ecommerce\Models\Colors::find($color->color_id)->translation('name');
                                    $color_images = \Plugin\Ecommerce\Models\ProductColorVariantImages::where('product_id', $product_details->id)
            ...
            <div class="card mb-30 @if (!empty($lang) && $lang != getdefaultlang()) area-disabled @endif">
                ...
                <div class="card-body">
                    ...
                    <div
                        ...
                        <div class="col-sm-9">
                            @php
                                $gallary_images = \Plugin\Ecommerce\Models\ProductGalleryImages::where('product_id', $product_details->id)
                                    ->pluck('image_id')
                                    ->toArray();
                            @endphp
                            @include('core::base.includes.media.media_input_multi_select', [
            ...
            <div class="card mb-30">
                ...
                <div class="card-body">
                    ...
                    @if (getEcommerceSetting('shipping_option') != null &&
                            getEcommerceSetting('shipping_option') == config('ecommerce.shipping_cost_options.profile_wise_rate'))
                        <div class="profile-wise-shiping-cost">
                            ...
                            <p class="font-13 mb-0 mt-3">
                                ...
                                <a href="{{ route('plugin.ecommerce.shipping.configuration') }}" class="btn-link">
                    ...
                    @if (getEcommerceSetting('shipping_option') == null ||
                            getEcommerceSetting('shipping_option') == config('ecommerce.shipping_cost_options.flat_rate'))
                        <div class="profile-wise-shiping-cost">
                    ...
                    @if (getEcommerceSetting('shipping_option') != null &&
                            getEcommerceSetting('shipping_option') == config('ecommerce.shipping_cost_options.product_wise_rate'))
                        <div class="product-wise-shiping-cost">
                            ...
                            <p class="font-13 mb-0">
                                ...
                                <a href="{{ route('plugin.ecommerce.shipping.configuration') }}"
                ...
                <div class="card-body">
                    @if (getEcommerceSetting('enable_tax_in_checkout') != config('settings.general_status.active'))
                        <p class="mt-0 font-13">
                            ...
                            <a href="{{ route('plugin.ecommerce.ecommerce.configuration', ['tab' => 'tax']) }}"
                    ...
                    @if (getEcommerceSetting('enable_tax_in_checkout') == config('settings.general_status.active'))
                        ...
                        <p class="mt-0 font-13">
                            ...
                            <a href="{{ route('plugin.ecommerce.ecommerce.settings.taxes.list') }}" target="_blank"
                ...
                <div class="card-body">
                    @if ($is_active_cod == config('settings.general_status.active'))
                        ...
                        <div
                                ...
                                <div class="d-flex d-sm-inline-flex align-items-center mr-sm-5 mb-3">
                                    <div class="custom-radio mr-3">
                                        <input type="radio" id="cod_anywhere"
                                            value="{{ config('ecommerce.cod_location.anywhere') }}" name="cod_location"
                                            checked onchange="codLocation()"
                                            @if ($product_details->cod_location_type == config('ecommerce.cod_location.anywhere')) checked @endif>
                                ...
                                <div class="d-flex d-sm-inline-flex align-items-center mr-sm-5 mb-3">
                                    <div class="custom-radio mr-3">
                                        <input type="radio" id="cod_in_custom_location"
                                            value="{{ config('ecommerce.cod_location.custom') }}" name="cod_location"
                                            onchange="codLocation()" @if ($product_details->cod_location_type == config('ecommerce.cod_location.custom')) checked @endif>
                            ...
                            <div
                                class="form-row mb-20 cod-contries_options {{ $product_details->cod_location_type == config('ecommerce.shipping_location.custom') ? '' : 'd-none' }}">
                            ...
                            <div
                                class="form-row mb-20 cod-states-options {{ $product_details->cod_location_type == config('ecommerce.shipping_location.custom') ? '' : 'd-none' }}">
                            ...
                            <div
                                class="form-row mb-20 cod-cities-options {{ $product_details->cod_location_type == config('ecommerce.shipping_location.custom') ? '' : 'd-none' }}">
                    ...
                    @else
                        <p class="mt-0 font-13">
                            ...
                            <a href="{{ route('plugin.ecommerce.payments.methods') }}"
                ...
                <div class="card-body">
                    ...
                    @if (getEcommerceSetting('enable_document_in_checkout') != config('settings.general_status.active'))
                        <p class="mt-0 font-13">
                            ...
                            <a href="{{ route('plugin.ecommerce.ecommerce.configuration', ['tab' => 'checkout']) }}"
...
@section('custom_scripts')
    ...
    <!--End Editor-->
    <script src="{{ asset('web-assets/backend/js/products.js?v=1') }}"></script>
    <script>
        ...
        (function($) {
            ...
            $('.product-tags-select').select2({
                ...
                ajax: {
                    url: '{{ route('plugin.ecommerce.product.tag.option') }}',
                    dataType: 'json',
                    method: "GET",
                    delay: 250,
                    data: function(params) {
            ...
            $('.cod-countries-select').select2({
                ...
                closeOnSelect: false,
                ajax: {
                    url: '{{ route('plugin.ecommerce.product.cod.countries.dropdown.option') }}',
                    dataType: 'json',
                    method: "GET",
                    delay: 250,
                    data: function(params) {
            ...
            $('.cod-state-select').select2({
                ...
                closeOnSelect: false,
                ajax: {
                    url: '{{ route('plugin.ecommerce.product.cod.state.dropdown.option') }}',
                    dataType: 'json',
                    method: "GET",
                    delay: 250,
                    data: function(params) {
            ...
            $('.cod-city-select').select2({
                ...
                closeOnSelect: false,
                ajax: {
                    url: '{{ route('plugin.ecommerce.product.cod.city.dropdown.option') }}',
                    dataType: 'json',
                    method: "GET",
                    delay: 250,
                    data: function(params) {
            ...
            $('.approve-product').on('click', function(e) {
                ...
                $.post('{{ route('plugin.ecommerce.product.approval.status.update') }}', {
                    _token: '{{ csrf_token() }}',
                    id: id
                }, function(data) {
                    location.reload();
        ...
        function selectColorVariant() {
            ...
            $.ajax({
                ...
                url: '{{ route('plugin.ecommerce.product.form.color.variant.image.input') }}',
                success: function(data) {
            ...
            if (attribute_id) {
                ...
                if (selected_items.indexOf(attribute_id) === -1) {
                    $.ajax({
                        ...
                        url: '{{ route('plugin.ecommerce.product.form.add.choice.option') }}',
                        success: function(data) {
        ...
        function variantConbination() {
            ...
            $.ajax({
                ...
                type: "POST",
                data: $('#product-form').serialize(),
                url: '{{ route('plugin.ecommerce.product.form.variant.combination') }}',
                success: function(data) {
        ...
        function codLocation() {
            ...
            if (location_type === '{{ config('ecommerce.cod_location.anywhere') }}') {
