    ...
    <div class="row">
                                        ...
                                        <td>
                                            <div class="dropdown-button">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a
                                                        href="{{ route('plugin.ecommerce.product.edit', ['id' => $collection->product->id, 'lang' => getDefaultLang()]) }}">
        ...
        <div class="col-sm-5">
            <div class="form-element py-30 mb-30">
                ...
                <form action="{{ route('plugin.ecommerce.product.collection.products.store') }}" method="POST">
                    @csrf
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.ecommerce.product.collection.products.remove') }}">
                        @csrf
            ...
            $('.bulk-action-btn').on('click', function(e) {
                ...
                if (action === 'delete_all') {
                    ...
                    if (selected_items.length > 0) {
                        $.post('{{ route('plugin.ecommerce.product.collection.products.remove.bulk') }}', {
                            _token: '{{ csrf_token() }}',
                            data: data
                        }, function(data) {
                            location.reload();
