    ...
    <div class="row">
                                    ...
                                    <td>
                                        <div class="dropdown-button">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a
                                                    href="{{ route('plugin.ecommerce.product.attributes.values.edit', $attribute->id) }}">
                                                    {{ translate('Edit') }}
                                                </a>
        ...
        <div class="col-md-5">
            <div class="form-element py-30 mb-30">
                ...
                <form action="{{ route('plugin.ecommerce.product.attributes.values.store') }}" method="POST">
                    @csrf
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.ecommerce.product.attributes.values.delete') }}">
                        @csrf
    ...
    <script>
        (function($) {
            ...
            $('.change-status').on('click', function(e) {
                ...
                $.post('{{ route('plugin.ecommerce.product.attributes.value.status.change') }}', {
                    _token: '{{ csrf_token() }}',
                    id: id
                }, function(data) {
                    location.reload();
