<form id="edit-shipping-rate-form">
                ...
                <div class="align-items-center d-flex mr-30">
                    <div class="custom-radio mr-1">
                        <input type="radio" name="edit_rate_type" id="edit_own_rate"
                            value="{{ config('ecommerce.shipping_rate_type.own_rate') }}"
                            @if ($shippingRate->rate_type == config('ecommerce.shipping_rate_type.own_rate')) checked @endif class="edit-rate-type-selector">
                ...
                <div class="align-items-center d-flex">
                    <div class="custom-radio mr-1">
                        <input type="radio" name="edit_rate_type" id="edit_courier_rate"
                            value="{{ config('ecommerce.shipping_rate_type.carrier_rate') }}"
                            @if ($shippingRate->rate_type == config('ecommerce.shipping_rate_type.carrier_rate')) checked @endif class="edit-rate-type-selector">
    ...
    <div class="form-row mb-20">
        <div class="col-sm-12">
            ...
            @else
                ...
                <a href="{{ route('plugin.ecommerce.shipping.configuration') }}#ShippingTimes"
    ...
    <div
        class="carrier-shipping-rate {{ $shippingRate->rate_type == config('ecommerce.shipping_rate_type.carrier_rate') ? '' : 'd-none' }}">
        <!--Carrier Selector-->
        <div class="form-row mb-20 courier-selector">
            <div class="col-sm-12">
                ...
                @else
                    ...
                    <a href="{{ route('plugin.ecommerce.shipping.configuration') }}#ShippingCarriers"
        ...
        <div class="form-row mb-20 courier-selector">
            ...
            <select name="shipped_by" class="theme-input-style">
                ...
                <option value="{{ config('ecommerce.shipped_by.by_air') }}"
                    @if ($shippingRate->shipping_medium == config('ecommerce.shipped_by.by_air')) selected @endif>
                    {{ translate('Air Freight') }}</option>
                <option value="{{ config('ecommerce.shipped_by.by_ship') }}"
                    @if ($shippingRate->shipping_medium == config('ecommerce.shipped_by.by_ship')) selected @endif>
                    {{ translate('Ocean Freight') }}</option>
                <option value="{{ config('ecommerce.shipped_by.by_rail') }}"
                    @if ($shippingRate->shipping_medium == config('ecommerce.shipped_by.by_rail')) selected @endif>
                    {{ translate('Rail Freight') }}</option>
                <option value="{{ config('ecommerce.shipped_by.by_train') }}"
                    @if ($shippingRate->shipping_medium == config('ecommerce.shipped_by.by_train')) selected @endif>
    ...
    <div
        class="own-shipping-rate {{ $shippingRate->rate_type == config('ecommerce.shipping_rate_type.own_rate') ? '' : 'd-none' }}">
        <!--Rate Name-->
        <div class="form-row mb-20">
            <div class="col-sm-12">
        ...
        <div
                ...
                <div class="d-flex d-sm-inline-flex align-items-center mr-sm-2 mb-3">
                    <div class="custom-radio mr-1">
                        <input type="radio" id="weight_based_edit" value="weight_based" name="conditionTypeEdit"
                            @if ($shippingRate->based_on == config('ecommerce.shipping_based_on.weight_based')) checked @endif class="edit-rate-condition-switcher">
                ...
                <div class="d-flex d-sm-inline-flex align-items-center mr-sm-2 mb-3">
                    <div class="custom-radio mr-1">
                        <input type="radio" id="price_based_edit" value="price_based" name="conditionTypeEdit"
                            @if ($shippingRate->based_on == config('ecommerce.shipping_based_on.price_based')) checked @endif class="edit-rate-condition-switcher">
            ...
            <div
                class="form-row weight-based {{ $shippingRate->based_on == config('ecommerce.shipping_based_on.weight_based') ? '' : 'd-none' }}">
                <div class="col-sm-6">
            ...
            <div
                class="form-row price-based {{ $shippingRate->based_on == config('ecommerce.shipping_based_on.price_based') ? '' : 'd-none' }}">
                <div class="col-sm-6">
    ...
    (function($) {
        ...
        $('.update-rate-btn').on('click', function(e) {
            ...
            $.ajax({
                ...
                url: '{{ route('plugin.ecommerce.shipping.rate.update') }}',
