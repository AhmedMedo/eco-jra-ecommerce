...
@section('main_content')
    ...
    <div class="row">
        <div class="col-lg-6 col-12" id="ShippingOptions">
            <div class="card mb-30">
                ...
                <div class="card-body">
                    <form action="{{ route('plugin.ecommerce.shipping.option.update') }}" method="POST">
                        @csrf
                        <div class="form-group mb-4">
                            <div class="d-flex align-items-center mb-3">
                                <div class="custom-radio mr-3">
                                    <input type="radio" id="flatRate" name="shipping_option"
                                        value="{{ config('ecommerce.shipping_cost_options.flat_rate') }}"
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="custom-radio mr-3">
                                    <input type="radio" id="productWise" name="shipping_option"
                                        value="{{ config('ecommerce.shipping_cost_options.product_wise_rate') }}"
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="custom-radio mr-3">
                                    <input type="radio" id="profileBased" name="shipping_option"
                                        value="{{ config('ecommerce.shipping_cost_options.profile_wise_rate') }}"
                                        @checked(SettingsRepository::getEcommerceSetting('shipping_option') ==
    ...
    <div
        ...
        SettingsRepository::getEcommerceSetting('shipping_option') == config('ecommerce.shipping_cost_options.flat_rate')
            ? ''
            : 'd-none' }}">
        <div class="col-lg-6 col-12">
            <div class="card mb-30">
                ...
                <div class="card-body">
                    <form action="{{ route('plugin.ecommerce.shipping.flat.rate.update') }}" method="POST">
                        @csrf
                        <div class="form-group mb-4">
                ...
                <div class="card-header bg-white border-bottom2">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center gap-15">
                            <a href="{{ route('plugin.ecommerce.shipping.profile.form') }}"
                        ...
                        @foreach ($shipping_profiles as $profile)
                            <div class="d-flex justify-content-between p-3 rounded shipping-profile mb-20">
                                ...
                                <div class="action-area">
                                    <a href="{{ route('plugin.ecommerce.shipping.profile.manage', $profile->id) }}"
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.ecommerce.shipping.profile.delete') }}">
                        @csrf
    ...
    <div id="delete-shipping-time-modal" class="delete-shipping-time-modal modal fade show" aria-modal="true"
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <p class="mt-1">{{ translate('Are you sure to delete this') }}?</p>
                    <form method="POST" action="{{ route('plugin.ecommerce.shipping.time.delete') }}">
                        @csrf
        ...
        (function($) {
            ...
            $('.store-shiping-time-btn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.shipping.time.store') }}',
