...
@section('main_content')
    <div class="align-items-center border-bottom2 d-flex flex-wrap gap-10 justify-content-between mb-4 pb-3">
        <h4><a href="{{ route('plugin.ecommerce.shipping.configuration') }}" class="black"><i
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            @if ($rate->has_condition == config('settings.general_status.active'))
                                                                                @if ($rate->based_on == config('ecommerce.shipping_based_on.weight_based'))
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.ecommerce.shipping.zones.delete') }}">
                        @csrf
    ...
    <div id="delete-rate-modal" class="delete-rate-modal modal fade show" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <p class="mt-1">{{ translate('Are you sure to delete this') }}?</p>
                    <form method="POST" action="{{ route('plugin.ecommerce.shipping.delete.rate') }}">
                        @csrf
                ...
                <div class="modal-body">
                    <form id="products-from">
                        <div class="form-row mb-20">
                            ...
                            <input type="hidden" name="profile_id" value="{{ $profile_info->id }}">
                            @php
                                $products = \Plugin\Ecommerce\Models\Product::whereNotIn('id', Plugin\Ecommerce\Models\ShippingProfileProducts::pluck('product_id'))
                                    ->select('id', 'name')
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.ecommerce.shipping.profile.product.remove') }}">
                        @csrf
        ...
        (function($) {
            ...
            function getCountriesOptions() {
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.shipping.location.ul.list') }}',
            ...
            function getSearchedLocations(searchKey) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.shipping.search.location.ul.list') }}',
                    success: function(response) {
                        if (response.success) {
                            if (response.found) {
                                $('.location-options').append(response.list);
            ...
            $('.create-new-zone').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.shipping.profile.zones.store') }}',
                    success: function(response) {
                        location.reload();
                    },
            ...
            $('.update-shipping-profile').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.shipping.profile.update') }}',
                    success: function(response) {
                        location.reload();
                    },
                    error: function(response) {
            ...
            $('.update-product-list').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.shipping.profile.update.product.list') }}',
                    success: function(response) {
                        location.reload();
                    },
            ...
            $('.edit-shipping-zone').click('on', function(e) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: data,
                    url: '{{ route('plugin.ecommerce.shipping.profile.zones.edit') }}',
            ...
            $('.edit-rate').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: data,
                    url: '{{ route('plugin.ecommerce.shipping.rate.edit') }}',
                    success: function(data) {
            ...
            $('.store-rate-btn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.shipping.store.rate') }}',
                    success: function(response) {
                        location.reload();
                    },
                    error: function(response) {
            ...
            $('.add-new-weight-range').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    type: "GET",
                    url: '{{ route('plugin.ecommerce.shipping.carrier.weight.range.input') }}',
                    success: function(data) {
