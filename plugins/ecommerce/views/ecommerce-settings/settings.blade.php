            ...
            <div class="theme-option-tab-wrap">
                <div class="nav flex-column border-right2 py-3" aria-orientation="vertical">
                    <a class="nav-link {{ $active_tab == 'general' ? 'active' : '' }}"
                        href="{{ route('plugin.ecommerce.ecommerce.configuration', ['tab' => 'general']) }}">
                    ...
                    <a class="nav-link {{ $active_tab == 'email-notification' ? 'active' : '' }}"
                        href="{{ route('plugin.ecommerce.ecommerce.configuration', ['tab' => 'email-notification']) }}">
                    ...
                    <a class="nav-link {{ $active_tab == 'tax' ? 'active' : '' }}"
                        href="{{ route('plugin.ecommerce.ecommerce.configuration', ['tab' => 'tax']) }}">
                    ...
                    @if (isActivePlugin('multivendor'))
                        <a class="nav-link {{ $active_tab == 'shop' ? 'active' : '' }}"
                            href="{{ route('plugin.ecommerce.ecommerce.configuration', ['tab' => 'shop']) }}">
        ...
        (function($) {
            ...
            $('.ecommerce-settings-update-btn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.ecommerce.configuration.update') }}',
