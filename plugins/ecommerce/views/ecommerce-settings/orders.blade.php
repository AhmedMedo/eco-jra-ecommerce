                ...
                <div class="input-group addon">
                    ...
                    <div class="input-group-append">
                        <select class="form-control" name="cancel_order_time_limit_unit">
                            <option value="{{ config('ecommerce.time_unit.Days') }}"
                                @if (getEcommerceSetting('cancel_order_time_limit_unit') == config('ecommerce.time_unit.Days')) selected @endif>
                                {{ translate('Days') }}</option>
                            <option value="{{ config('ecommerce.time_unit.Hours') }}"
                                @if (getEcommerceSetting('cancel_order_time_limit_unit') == config('ecommerce.time_unit.Hours')) selected @endif>
                                {{ translate('Hours') }}</option>
                            <option value="{{ config('ecommerce.time_unit.Minutes') }}"
                                @if (getEcommerceSetting('cancel_order_time_limit_unit') == config('ecommerce.time_unit.Minutes')) selected @endif>
                ...
                <div class="input-group addon">
                    ...
                    <div class="input-group-append">
                        <select class="form-control" name="return_order_time_limit_unit">
                            <option value="{{ config('ecommerce.time_unit.Days') }}"
                                @if (getEcommerceSetting('return_order_time_limit_unit') == config('ecommerce.time_unit.Days')) selected @endif>
                                {{ translate('Days') }}</option>
                            <option value="{{ config('ecommerce.time_unit.Hours') }}"
                                @if (getEcommerceSetting('return_order_time_limit_unit') == config('ecommerce.time_unit.Hours')) selected @endif>
                                {{ translate('Hours') }}</option>
                            <option value="{{ config('ecommerce.time_unit.Minutes') }}"
                                @if (getEcommerceSetting('return_order_time_limit_unit') == config('ecommerce.time_unit.Minutes')) selected @endif>
                                {{ translate('Minutes') }}</option>
                        </select>
                    </div>
                </div>
