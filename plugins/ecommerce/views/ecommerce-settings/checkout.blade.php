 <div class="card">
     <div class="card-body">
         ...
         <div class="form-row mb-20">
             ...
             <div class="col-sm-5">
                 <p class="mt-0 font-13">
                     ...
                     <br>
                     <a href="http://fashly.docs.themelooks.us/blog/cron-job-setup" target="_blank"
                         class="btn-link">{{ translate('How to setup cron job ?') }}
                     </a>
                 </p>
             </div>
         </div>
         <div class="form-row mb-20 {{ isActivePlugin('coupon') ? '' : 'area-disabled mb-0' }}">
             <div class="col-sm-6">
         ...
         @endif
         <!--Wallet-->
         <div class="form-row mb-20 {{ isActivePlugin('wallet') ? '' : 'area-disabled mb-0' }}">
             <div class="col-sm-6">
         ...
         <!--End Documents-->
         <!--Carriers-->
         <div class="form-row mb-20 {{ isActivePlugin('carrier') ? '' : 'area-disabled mb-0' }}">
             <div class="col-sm-6">
         ...
         <!--End carriers-->
         <!--Pickup points-->
         <div class="form-row mb-20 {{ isActivePlugin('pickuppoint') ? '' : 'area-disabled mb-0' }}">
             <div class="col-sm-6">
