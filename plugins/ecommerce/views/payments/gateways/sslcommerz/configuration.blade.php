@php
    ...
    $selecected_currency = \Plugin\Ecommerce\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'ssl_currency');
    ...
    <div class="configuration">
        <form id="credential-form-{{ $method->id }}">
            ...
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <input type="text" class="theme-input-style" name="sslcz_store_id" placeholder="Enter Store Id"
                        value="{{ \Plugin\Ecommerce\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'sslcz_store_id') }}" />
                </div>
            </div>
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <input type="text" class="theme-input-style" name="sslcz_store_password"
                        ...
                        value="{{ \Plugin\Ecommerce\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'sslcz_store_password') }}" />
                </div>
            </div>
            <div class="form-group mb-20">
                <div class="d-flex">
            ...
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <textarea name="sslcommerz_instruction" class="theme-input-style">{{ \Plugin\Ecommerce\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'sslcommerz_instruction') }}</textarea>
                </div>
            </div>
            <div>
