    ...
    <div>
        <form id="credential-form-{{ $method->id }}">
                ...
                <div class="input-option">
                    @include('core::base.includes.media.media_input', [
                        ...
                        'data' => \Plugin\Ecommerce\Repositories\PaymentMethodRepository::configKeyValue(
                            config('ecommerce.payment_methods.bank'),
                            'bank_logo'),
                    ])
            ...
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <textarea name="bank_instruction" id="bank_instruction" class="theme-input-style">{{ \Plugin\Ecommerce\Repositories\PaymentMethodRepository::configKeyValue(config('ecommerce.payment_methods.bank'), 'bank_instruction') }}</textarea>
                </div>
            </div>
            <div>
