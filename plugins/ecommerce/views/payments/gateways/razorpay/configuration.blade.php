@php
    ...
    $selecected_currency = \Plugin\Ecommerce\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'razorpay_currency');
    ...
    <div class="configuration">
        <form id="credential-form-{{ $method->id }}">
            ...
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <textarea name="razorpay_instruction" class="theme-input-style">{{ \Plugin\Ecommerce\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'razorpay_instruction') }}</textarea>
                </div>
            </div>
            <div>
