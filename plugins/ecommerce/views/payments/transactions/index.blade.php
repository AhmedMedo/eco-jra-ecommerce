        ...
        <div class="col-12">
            <div class="card mb-30">
                ...
                <div class="px-2 filter-area d-flex align-items-center">
                    <form method="get" action="{{ route('plugin.ecommerce.payments.transactions.history') }}">
                    ...
                    <a class="btn btn-danger long mb-auto"
                        href="{{ route('plugin.ecommerce.payments.transactions.history') }}">{{ translate('Clear Filter') }}</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($transaction->customer_info != null)
                                                <a
                                                    href="{{ route('plugin.ecommerce.customers.details', ['id' => $transaction->customer_info->id]) }}">{{ $transaction->customer_info->name }}</a>
                                            @else
