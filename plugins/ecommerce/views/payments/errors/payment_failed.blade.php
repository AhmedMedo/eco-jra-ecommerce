...
<head>
    ...
    <!-- ======= MAIN STYLES ======= -->
    <link rel="stylesheet" href="{{ asset('web-assets/backend/css/style.css') }}">
    <!-- ======= END MAIN STYLES ======= -->
</head>
...
<body>
    <div class="mn-vh-100 d-flex align-items-center mx-1350">
        <div class="container-fluid">
            <!-- Card -->
            <div class="card justify-content-center py-5 px-4 border-0">
                <div class="row justify-content-center my-5 pt-4">
                    <div class="col-xl-12 text-center">
                        <h1 class="mb-20">{{ translate('Payment Error') }}</h1>
                        <p class="mxw-550">{{ translate('Payment Failed. Please try again.') }}</p>
                        <div class="mt-3 mb-30 pb-2">
                            <a href="/" class="details-btn">
                                {{ translate('Back To Home') }}
                                <img src="{{ asset('web-assets/backend/img/svg/left-arrow-c2.svg') }}"
                                    alt="" class="svg">
                            </a>
                        </div>
                    </div>
