...
use Plugin\Ecommerce\Repositories\SettingsRepository as EcommerceSettingRepository;
...
class SettingsRepository
{
    ...
    public static function siteSettings()
    {
        try {
            $data = [
                'shipping_option'                         => getEcommerceSetting('shipping_option') != null ? getEcommerceSetting('shipping_option') : config('ecommerce.shipping_cost_options.profile_wise_rate'),
                ...
                'is_active_multivendor'                   => isActivePlugin('multivendor') ? config('settings.general_status.active') : config('settings.general_status.in_active'),
            ];
