...
use Plugin\Ecommerce\Models\CartItem;
...
use Plugin\Ecommerce\Models\OrderPackageTracking;
...
use Plugin\Ecommerce\Http\Resources\ShippingRateCollection;
use Plugin\Ecommerce\Http\Resources\SingleShippingRateCollection;
use Plugin\Ecommerce\Models\BankPayment;
...
class OrderRepository
{
    ...
    public function checkoutConfiguration()
    {
        try {
            $data = [
                ...
                'is_active_wallet'                        => isActivePlugin('wallet') ? config('settings.general_status.active') : config('settings.general_status.in_active'),
                'is_active_pickuppoint'                   => isActivePlugin('pickuppoint') ? config('settings.general_status.active') : config('settings.general_status.in_active'),
                'is_active_coupon'                        => isActivePlugin('coupon') ? config('settings.general_status.active') : config('settings.general_status.in_active'),
            ];
    ...
    public function orderCounter($shipping_type)
    {
        try {
            ...
            $temp['all'] = DB::table('tl_com_ordered_products')
                ...
                ->where('tl_users.user_type', config('ecommerce.user_type.admin'))
            ...
            $temp['pending'] = DB::table('tl_com_ordered_products')
                ...
                ->select($data)
                ->where('tl_users.user_type', config('ecommerce.user_type.admin'))
                ->where('tl_com_orders.shipping_type', $shipping_type)->where('tl_com_ordered_products.delivery_status', config('ecommerce.order_delivery_status.pending'))->get()->count();
            ...
            $temp['delivered'] = DB::table('tl_com_ordered_products')
                ...
                ->select($data)
                ->where('tl_users.user_type', config('ecommerce.user_type.admin'))
                ->where('tl_com_orders.shipping_type', $shipping_type)->where('tl_com_ordered_products.delivery_status', config('ecommerce.order_delivery_status.delivered'))->get()->count();
            ...
            $temp['processing'] = DB::table('tl_com_ordered_products')
                ...
                ->select($data)
                ->where('tl_users.user_type', config('ecommerce.user_type.admin'))
                ->where('tl_com_orders.shipping_type', $shipping_type)->where('tl_com_ordered_products.delivery_status', config('ecommerce.order_delivery_status.processing'))->get()->count();
            ...
            $temp['ready_to_ship'] = DB::table('tl_com_ordered_products')
                ...
                ->select($data)
                ->where('tl_users.user_type', config('ecommerce.user_type.admin'))
                ->where('tl_com_orders.shipping_type', $shipping_type)->where('tl_com_ordered_products.delivery_status', config('ecommerce.order_delivery_status.ready_to_ship'))->get()->count();
            ...
            $temp['shipped'] = DB::table('tl_com_ordered_products')
                ...
                ->select($data)
                ->where('tl_users.user_type', config('ecommerce.user_type.admin'))
                ->where('tl_com_orders.shipping_type', $shipping_type)->where('tl_com_ordered_products.delivery_status', config('ecommerce.order_delivery_status.shipped'))->get()->count();
            ...
            $temp['cancelled'] = DB::table('tl_com_ordered_products')
                ...
                ->select($data)
                ->where('tl_users.user_type', config('ecommerce.user_type.admin'))
                ->where('tl_com_orders.shipping_type', $shipping_type)->where('tl_com_ordered_products.delivery_status', config('ecommerce.order_delivery_status.cancelled'))->get()->count();
            ...
            $temp['paid'] = DB::table('tl_com_ordered_products')
                ...
                ->select($data)
                ->where('tl_users.user_type', config('ecommerce.user_type.admin'))
                ->where('tl_com_orders.shipping_type', $shipping_type)->where('tl_com_ordered_products.payment_status', config('ecommerce.order_payment_status.paid'))->get()->count();
            ...
            $temp['unpaid'] = DB::table('tl_com_ordered_products')
                ...
                ->select($data)
                ->where('tl_users.user_type', config('ecommerce.user_type.admin'))
                ->where('tl_com_orders.shipping_type', $shipping_type)->where('tl_com_ordered_products.payment_status', config('ecommerce.order_payment_status.unpaid'))->get()->count();
            return $temp;
        } catch (\Exception $e) {
            return null;
        } catch (\Error $e) {
    ...
    public function sellerOrderCounter($shipping_type)
    {
        try {
            ...
            $temp['all'] = DB::table('tl_com_ordered_products')
                ...
                ->leftjoin('tl_users', 'tl_users.id', '=', 'tl_com_ordered_products.seller_id')
                ->groupBy('tl_com_ordered_products.order_id')
                ->where('tl_users.user_type', config('ecommerce.user_type.seller'))
                ->where('tl_com_orders.shipping_type', $shipping_type)
                ->select($data)->get()->count();
    ...
    public function singleSellerOrderCounter($seller_id)
    {
        try {
            ...
            $temp['pending'] = DB::table('tl_com_ordered_products')
                ...
                ->where('tl_com_ordered_products.seller_id', $seller_id)
                ->select($data)
                ->where('tl_com_ordered_products.delivery_status', config('ecommerce.order_delivery_status.pending'))
                ->get()
                ->count();
            ...
            $temp['delivered'] = DB::table('tl_com_ordered_products')
                ...
                ->where('tl_com_ordered_products.seller_id', $seller_id)
                ->select($data)
                ->where('tl_com_ordered_products.delivery_status', config('ecommerce.order_delivery_status.delivered'))
                ->get()
                ->count();
            ...
            $temp['processing'] = DB::table('tl_com_ordered_products')
                ...
                ->where('tl_com_ordered_products.seller_id', $seller_id)
                ->select($data)
                ->where('tl_com_ordered_products.delivery_status', config('ecommerce.order_delivery_status.processing'))
                ->get()
                ->count();
            ...
            $temp['ready_to_ship'] = DB::table('tl_com_ordered_products')
                ...
                ->where('tl_com_ordered_products.seller_id', $seller_id)
                ->select($data)
                ->where('tl_com_ordered_products.delivery_status', config('ecommerce.order_delivery_status.ready_to_ship'))
                ->get()
                ->count();
            ...
            $temp['shipped'] = DB::table('tl_com_ordered_products')
                ...
                ->where('tl_com_ordered_products.seller_id', $seller_id)
                ->select($data)
                ->where('tl_com_ordered_products.delivery_status', config('ecommerce.order_delivery_status.shipped'))
                ->get()
                ->count();
            ...
            $temp['cancelled'] = DB::table('tl_com_ordered_products')
                ...
                ->where('tl_com_ordered_products.seller_id', $seller_id)
                ->select($data)
                ->where('tl_com_ordered_products.delivery_status', config('ecommerce.order_delivery_status.cancelled'))
                ->get()
                ->count();
            ...
            $temp['paid'] = DB::table('tl_com_ordered_products')
                ...
                ->where('tl_com_ordered_products.seller_id', $seller_id)
                ->select($data)
                ->where('tl_com_ordered_products.payment_status', config('ecommerce.order_payment_status.paid'))
                ->get()
                ->count();
            ...
            $temp['unpaid'] = DB::table('tl_com_ordered_products')
                ...
                ->where('tl_com_ordered_products.seller_id', $seller_id)
                ->select($data)
                ->where('tl_com_ordered_products.payment_status', config('ecommerce.order_payment_status.unpaid'))
                ->get()
                ->count();
            return $temp;
        } catch (\Exception $e) {
    ...
    public function orderList($request, $shipping_type = null, $order_type = "inhouse", $seller_id = null)
    {
        try {
            ...
            if ($order_type != null && $order_type == "inhouse") {
                $query = $query->where('tl_users.user_type', config('ecommerce.user_type.admin'));
            }

            if ($order_type != null && $order_type == "seller") {
                $query = $query->where('tl_users.user_type', config('ecommerce.user_type.seller'));
            }
    ...
    public function shippingOptions($request)
    {
        try {
            ...
            if ($request->has('shipping_type')  && $request['shipping_type'] == 'home_delivery') {
                ...
                if ($shipping_option == null || $shipping_option == config('ecommerce.shipping_cost_options.flat_rate')) {
                    return $this->flatRateShippingCostCalculation($request, $allow_free_shipping);
                }

                //Product wise  shipping cost
                if ($shipping_option != null && $shipping_option == config('ecommerce.shipping_cost_options.product_wise_rate')) {
                    return $this->productWiseShippingCostCalculation($request, $allow_free_shipping);
                }
                //Profile Based shipping cost
                if ($shipping_option != null || $shipping_option == config('ecommerce.shipping_cost_options.profile_wise_rate')) {
        ...
        foreach ($rates as $rate) {
            ...
            if ($rate->has_condition == config('settings.general_status.active')) {
                ...
                if ($rate->rate_type != 'own_rate') {
                    ...
                    if (isActivePlugin('carrier') && SettingsRepository::getEcommerceSetting('enable_carrier_in_checkout') == config('settings.general_status.active')) {
    ...
    public function customerCheckout($request)
    {
        try {
            ...
            DB::beginTransaction();
            $shipping_type = $request->has('pickup_point') ? config('ecommerce.order_type.local_pickup') : config('ecommerce.order_type.home_delivery');
            $order = new Orders;
            ...
            $order->delivery_status = config('ecommerce.order_delivery_status.pending');

            //Wallet payment
            if ($request['wallet_payment'] == config('settings.general_status.active') && isActivePlugin('wallet')) {
                $order->payment_status = config('ecommerce.order_payment_status.paid');
                ...
                $wallet_transaction->entry_type = config('ecommerce.wallet_entry_type.debit');
                $wallet_transaction->recharge_type = config('ecommerce.wallet_recharge_type.cart');
                ...
                $wallet_transaction->status = config('ecommerce.wallet_transaction_status.accept');
                $wallet_transaction->payment_method_id = null;
                $wallet_transaction->transaction_id = null;
                $wallet_transaction->save();
            } else {
                $order->payment_status = config('ecommerce.order_payment_status.unpaid');
            }
            $order->save();
    ...
    public function storeOrderProducts($order_id, $products, $customer_id)
    {
        ...
        foreach ($products as $product) {
            ...
            $paid_amount = 0;
            $payment_status = config('ecommerce.order_payment_status.unpaid');
            ...
            if ($order->wallet_payment == config('settings.general_status.active')) {
                ...
                $payment_status = config('ecommerce.order_payment_status.paid');
            }
            ...
            $order_product->delivery_status = config('ecommerce.order_delivery_status.pending');
            $order_product->payment_status = $payment_status;
            $order_product->seller_id = $product_info->supplier;
            $order_product->return_status = $product_info->is_refundable == config('settings.general_status.active') ? config('ecommerce.product_return_status.available') : config('ecommerce.product_return_status.not_available');
            $order_product->save();
        ...
        try {
            ...
            if ($order != null) {
                ...
                foreach ($all_products as $product) {
                    if ($product->delivery_status != config('ecommerce.order_delivery_status.cancelled')) {
                        $product->delivery_status = config('ecommerce.order_delivery_status.processing');
                        $product->save();
                        $this->insertOrderTrackingData($order_id, $product->id, 'Your order has been accepted');
                        //Filter seller ids
                        if ($seller_id == null && $product->seller_id != null && auth()->user()->user_type == null && isActivePlugin('multivendor')) {
                ...
                if ($order->products->count() == $all_products->count()) {
                    $order->delivery_status = config('ecommerce.order_delivery_status.processing');
                    $order->save();
                }
        ...
        try {
            ...
            if ($order != null) {
                ...
                foreach ($all_products as $product) {
                    ...
                    $product->delivery_status = config('ecommerce.order_delivery_status.cancelled');
                    $product->save();
                ...
                if ($order->products->count() == $all_products->count()) {
                    $order->delivery_status = config('ecommerce.order_delivery_status.cancelled');
                    $order->save();
                }
        ...
        try {
            ...
            foreach ($request['product'] as $product) {
                ...
                if ($order_product->payment_status != $request['payment_status']) {
                    $payment_change_message = $order_product->payment_status == config('ecommerce.order_payment_status.paid') ? "Your order has been make unpaid" : "Payment completed of your order";
                ...
                if ($request->has('comment') && $request['comment'] != null) {
                    ...
                    if ($order_product->delivery_status != $request['delivery_status']) {
                        if ($request['delivery_status'] == config('ecommerce.order_delivery_status.pending')) {
                            $delivery_change_message = 'Your package has been pending';
                            $mail_title = "Your order has been pending";
                        } else if ($request['delivery_status'] == config('ecommerce.order_delivery_status.processing')) {
                            $delivery_change_message = 'Your order is being accepted';
                            $mail_title = "Order accepted";
                        } else if ($request['delivery_status'] == config('ecommerce.order_delivery_status.ready_to_ship')) {
                        ...
                        } else if ($request['delivery_status'] == config('ecommerce.order_delivery_status.shipped')) {
                        ...
                        } else if ($request['delivery_status'] == config('ecommerce.order_delivery_status.delivered')) {
                        ...
                        } else if ($request['delivery_status'] == config('ecommerce.order_delivery_status.cancelled')) {
                ...
                if ($delivery_change_message != null) {
                    ...
                    //Filter seller id
                    if ($order_product->seller_id != null && auth()->user()->user_type == null && isActivePlugin('multivendor')) {
                ...
                if ($order_product->payment_status != $request['payment_status']) {
                    ...
                    if ($request['payment_status'] == config('ecommerce.order_payment_status.paid')) {
                ...
                if ($request['delivery_status'] == config('ecommerce.order_delivery_status.delivered')) {
        ...
        try {
            ...
            if ($item != null) {
                if ($status_type == 'delivery_status') {
                    ...
                    $delivery_change_message = null;
                    if ($status == config('ecommerce.order_delivery_status.cancelled')) {
                    ...
                    if ($delivery_change_message != null) {
                        ...
                        if ($item->seller_id != null && auth()->user()->user_type == null && isActivePlugin('multivendor')) {
                            if (auth('jwt-customer')->user() == null) {
                                $seller_message = "Order status updated. Order code " . $order->order_code;
            ...
            if ($order != null) {
                ...
                foreach ($order_products as $product) {
                    if ($product->payment_status != $status) {
                        ...
                        if ($status == config('ecommerce.order_payment_status.paid')) {
    ...
    public function returnOrder($request)
    {
        try {
            if (isActivePlugin('refund')) {
                ...
                $return_req->return_status = config('ecommerce.return_request_status.pending');
                $return_req->refund_status = config('ecommerce.return_request_payment_status.pending');
                $return_req->save();

                //update order product return status
                $order_product->return_status = config('ecommerce.product_return_status.processing');
                $order_product->save();
    ...
    public function getShippingLabelContent($order_id, $order_products)
    {
        try {
            ...
            $shipping_type = $order_info->shipping_type == config('ecommerce.order_type.home_delivery') ? 'Home Delivery' : 'Local Pickup';

            $payment_method = $order_info->payment_method != config('ecommerce.payment_methods.cod') ? 'Non COD' : 'COD';
            ...
            $total_payable_amount = $order_info->payment_method == config('ecommerce.payment_methods.cod') ? $due_amount : 0;
    ...
    public function getInvoiceData($order_id, $order_products)
    {
        try {
            ...
            $payment_method = null;
            if ($order_info->payment_method == config('ecommerce.payment_methods.paypal')) {
                $payment_method = 'Paypal';
            } elseif ($order_info->payment_method == config('ecommerce.payment_methods.stripe')) {
    ...
    public  function generateOrderPaymentLink($order_id, $customer_id, $customer_type, $payment_method, $payable_amount, $is_wallet_payment = 2)
    {
        ...
        if ($is_wallet_payment == config('settings.general_status.active')) {
            ...
            if ($payment_method == config('ecommerce.payment_methods.cod')) {
                return $base_url . '/order-success/' . $order_id;
            } else {
                if ($payment_method == config('ecommerce.payment_methods.bank')) {
