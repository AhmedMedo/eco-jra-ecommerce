        ...
        return [
            'data' => $this->collection->map(function ($data) {
                return [
                    ...
                    'shop_name'    => isActivePlugin('multivendor')  && $data->product->supplier != null ? $data->product->seller->shop->shop_name : null,
                    'shop_slug'    => isActivePlugin('multivendor') && $data->product->supplier != null ? $data->product->seller->shop->shop_slug : null,
                ];
            })
        ];
    }
