...
use Plugin\Ecommerce\Models\AttributeValues;
...
class SingleProductCollection extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'attribute' => $this->has_variant == config('ecommerce.product_variant.variable') ?  $this->productAttributes() : null,
            'selectedVariant' => $this->has_variant == config('ecommerce.product_variant.variable') ?  $this->selectedVariant() : null,
            'permalink' => $this->permalink,
            'oldPrice' => $this->base_price(),
            'price' => $this->current_price(),
            'has_variant' => $this->has_variant,
            'price_range_min' => $this->has_variant == config('ecommerce.product_variant.variable') ?  $this->priceRangeMinValue('new') : null,
            'price_range_max' => $this->has_variant == config('ecommerce.product_variant.variable')  ?  $this->priceRangeMaxValue('new') : null,
            'price_range_min_old' => $this->has_variant == config('ecommerce.product_variant.variable') ?  $this->priceRangeMinValue('old') : null,
            'price_range_max_old' => $this->has_variant == config('ecommerce.product_variant.variable') ?  $this->priceRangeMaxValue('old') : null,
