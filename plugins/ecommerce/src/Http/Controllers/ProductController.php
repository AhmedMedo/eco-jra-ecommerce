...
use Plugin\Ecommerce\Models\ShippingProfile;
use Plugin\Ecommerce\Models\ProductAttribute;
use Plugin\Ecommerce\Models\ProductShareOption;
use Plugin\Ecommerce\Repositories\UnitRepository;
use Plugin\Ecommerce\Http\Requests\ProductRequest;
use Plugin\Ecommerce\Repositories\BrandRepository;
use Plugin\Ecommerce\Repositories\ColorRepository;
use Plugin\Ecommerce\Repositories\VatTaxRepository;
use Plugin\Ecommerce\Repositories\ProductRepository;
use Plugin\Ecommerce\Repositories\CategoryRepository;
use Plugin\Ecommerce\Repositories\LocationRepository;
use Plugin\Ecommerce\Repositories\ProductTagsRepository;
use Plugin\Ecommerce\Repositories\ProductAttributeRepository;
use Plugin\Ecommerce\Repositories\ProductConditionRepository;
use Plugin\Ecommerce\Repositories\ProductCollectionRepository;
...
class ProductController extends Controller
{
    ...
    {
        return view('plugin/ecommerce::products.product.product_list')->with([
    ...
    {
        return view('plugin/ecommerce::products.product.product_quick_action_modal')->with([
    ...
    {
        return view('plugin/ecommerce::products.product.add_new_product')->with([
    ...
    {
        if ($request['product_type'] == config('ecommerce.product_variant.variable') && !$request->has('variations')) {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.product.list');
        } else {
    ...
    {
        return view('plugin/ecommerce::products.product.edit_product')->with([
    ...
    public function updateProduct(ProductRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.product.edit', ['id' => $request->id, 'lang' => $request->lang]);
        } else {
            toastNotification('error', translate('Action failed'), 'Failed');
            return redirect()->back();
        }
    ...
    public function addProductChoiceOption(Request $request)
    {
        ...
        return view('plugin/ecommerce::products.product.choice_option')->with([
    ...
    public function variantCombination(Request $request)
    {
        ...
        return view('plugin/ecommerce::products.product.variant_combination')->with(
            [
    ...
    public function colorVariantImageInput(Request $request)
    {
        ...
        return view('plugin/ecommerce::products.product.color_variant_images')->with(
            [
                'colors' => $colors,
    ...
    public function shareOptions()
    {
        ...
        return view('plugin/ecommerce::products.product.share_options')->with(
            [
    ...
    public function productReviewsList(Request $request)
    {
        ...
        return view('plugin/ecommerce::products.product.reviews')->with(
            [
                'reviews' => $reviews,
            ]
        );
    ...
    public function productReviewDetails(Request $request)
    {
        ...
        return view('plugin/ecommerce::products.product.review_details')->with(
            [
                'details' => $details,
            ]
        );
    ...
    public function productReviewdelete(Request $request)
    {
        ...
        if ($res) {
            ...
            return to_route('plugin.ecommerce.product.reviews.list');
        } else {
