...
use Plugin\Ecommerce\Repositories\ShippingRepository;
use Plugin\Ecommerce\Http\Requests\ShippingRateRequest;
use Plugin\Ecommerce\Http\Requests\ShippingTimeRequest;
use Plugin\Ecommerce\Http\Requests\ShippingZoneRequest;
use Plugin\Ecommerce\Http\Requests\ShippingProfileRequest;
...
class ShippingController extends Controller
{
    ...
    {
        return view('plugin/ecommerce::shipping.configuration.index')->with(
            [
    ...
    public function updateShippingOption(Request $request)
    {
        ...
        return  to_route('plugin.ecommerce.shipping.configuration');
    }
    /**
     * Will update shipping option
     * 
    ...
    public function deleteShippingTime(Request $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.shipping.configuration');
        } else {
     ...
     * 
     * @param \Plugin\Ecommerce\Http\Requests\ShippingTimeRequest $request
    ...
    {
        return view('plugin/ecommerce::shipping.configuration.shipping_profile_form');
    }
    /**
     * Will store shipping profile
     * 
     * @param \Plugin\Ecommerce\Http\Requests\ShippingProfileRequest $request
     * @return mixed
     */
    public function storeShippingProfile(ShippingProfileRequest $request)
    {
        ...
        if ($res != null) {
            ...
            return redirect()->route('plugin.ecommerce.shipping.profile.manage', $res);
        } else {
    ...
    public function manageShippingProfile($id)
    {
        ...
        return view('plugin/ecommerce::shipping.configuration.manage_profile')->with(
            [
    ...
    public function locationUlList(Request $request)
    {
        try {
            ...
            return response()->json(
                [
                    'success' => true,
                    'list' => View::make('plugin/ecommerce::shipping.configuration.location_options')->with(['countries' => $countries, 'profile_id' => $request['profile_id']])->render(),
                ]
            );
        } catch (\Exception $e) {
            return response()->json(
    ...
    public function locationUlListEdt(Request $request)
    {
        try {
            ...
            return response()->json(
                [
                    'success' => true,
                    'list' => View::make('plugin/ecommerce::shipping.configuration.edit_zone_location_option')->with(['countries' => $countries, 'profile_id' => $request['profile_id'], 'zone_id' => $request['zone_id']])->render(),
                ]
            );
        } catch (\Exception $e) {
            return response()->json(
    ...
    {
        return view('plugin/ecommerce::shipping.configuration.edit_shipping_zone')->with(
            [
    ...
    public function deleteZone(Request $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.shipping.profile.manage', $request['profile_id']);
        } else {
    ...
    public function editShippingRate(Request $request)
    {
        ...
        return view('plugin/ecommerce::shipping.configuration.edit_shipping_rate')->with(
            [
    ...
    public function removeProduct(Request $request)
    {
        try {
            ...
            return to_route('plugin.ecommerce.shipping.profile.manage', ['id' => $request['profile_id'], 'module' => 'products']);
        } catch (\Exception $e) {
            DB::rollBack();
