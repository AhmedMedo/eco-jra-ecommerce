...
class ShippingRate extends Model
{
    ...
    public function shippied_by()
    {
        ...
        if ($medium == config('ecommerce.shipped_by.by_air')) {
            return translate('Air Freight');
        } elseif ($medium == config('ecommerce.shipped_by.by_ship')) {
            return translate('Ocean Freight');
        } elseif ($medium == config('ecommerce.shipped_by.by_rail')) {
            return translate('Rail Freight');
        } elseif ($medium == config('ecommerce.shipped_by.by_train')) {
