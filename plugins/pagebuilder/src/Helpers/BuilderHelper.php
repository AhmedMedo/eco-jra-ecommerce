...
class BuilderHelper
{
    ...
    {
        $active_theme = getActiveTheme();
        $css_path = base_path("themes/{$active_theme->location}builder-assets/css/{$permalink}.css");
        $json_path = base_path("themes/{$active_theme->location}builder-assets/css/{$permalink}.json");
