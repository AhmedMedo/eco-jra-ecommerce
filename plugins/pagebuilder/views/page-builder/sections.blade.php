...
@section('custom_css')
    <!-- Jquery UI -->
    <link href="{{ asset('web-assets/backend/plugins/jquery-ui/jquery-ui.min.css') }}" rel="stylesheet">
    <!-- Summernote -->
                                            ...
                                            @if (count($layout->layout_widgets))
                                                @foreach ($layout->layout_widgets as $layout_widget)
                                                    <div class="section-widget"
                                                        ...
                                                        @php
                                                            $condition1 = $layout_widget->widget->name == 'flash_deal' && !isActivePlugin('flashdeal');
                                                            $condition2 = $layout_widget->widget->name == 'seller_list' && !isActivePlugin('multivendor');
                                                            $bg = '';
                            ...
                            <div class="properties-wrapper d-none">
                                ...
                                <div class="form-row save-section mt-3">
                                    ...
                                    <div class="col-12 text-right" id="save-properties">
                                        <img src="{{ asset('loader.svg') }}" alt="loader" class="loader d-none"
                            ...
                            <div class="widget-list-wrapper">
                                ...
                                <div class="widget-list row">
                                    @foreach ($widgets as $widget)
                                        @if ($widget['name'] == 'flash_deal' && !isActivePlugin('flashdeal'))
                                            @continue
                                        @endif
                                        @if ($widget['name'] == 'seller_list' && !isActivePlugin('multivendor'))
                                            @continue
                                        @endif
                                            ...
                                            <div class="card card-body px-3 py-3">
                                                <div class="popover_wrapper">
                                                    ...
                                                    <div class="popover_content">
                                                        <img alt="{{ $widget['name'] }}"
                                                            src="{{ asset('/plugins/pagebuilder/assets/img/' . $widget['name'] . '.png') }}">
                                                    </div>
                                                </div>
...
@section('custom_scripts')
    ...
    <!-- Load The Srcripts -->
    @include('plugin/pagebuilder::page-builder.includes.scripts')
@endsection
