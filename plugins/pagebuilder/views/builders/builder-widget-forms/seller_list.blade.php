    ...
    <div class="tab-pane fade show active" id="content-info" role="tabpanel" aria-labelledby="content-info-tab">
        ...
        <div class="form-row mb-3">
            ...
            <div class="col-12 mt-3">
                <img src="{{ asset('public/web-assets/frontend/themes/fashion-theme/assets/img/seller_with_banner.png') }}"
                ...
                <img src="{{ asset('public/web-assets/frontend/themes/fashion-theme/assets/img/seller_without_banner.png') }}"
