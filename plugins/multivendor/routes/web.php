...
Route::group(['prefix' => getAdminPrefix(), 'middleware' => 'auth'], function () {
    ...
    //Seller List
    Route::middleware(['vhost',  'can:Manage Sellers'])->group(function () {
     ...
     * Seller Products
     */
    Route::middleware(['vhost',  'can:Manage Seller Products'])->group(function () {
     ...
     * Seller Settings
     */
    Route::middleware(['vhost',  'can:Manage Seller Settings'])->group(function () {
