...
<head>
    ...
    <title>Forgot Password - Ecojarah</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div class="text-center">
                ...
                <!-- Subtitle -->
                <p class="text-lg text-gray-600 mb-8">Reset your password</p>
            </div>
            ...
            <form class="space-y-6" action="{{ route('plugin.multivendor.buyer.v2.password.email') }}" method="POST">
                @csrf
