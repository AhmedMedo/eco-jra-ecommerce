                            ...
                            @if ($earnings->count() > 0)
                                @foreach ($earnings as $key => $earning)
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="{{ route('plugin.ecommerce.orders.details', ['id' => $earning->order->id]) }}">
                                        ...
                                        <td>
                                            @if ($earning->status == config('ecommerce.seller_earning_status.approve'))
                                                <p class="badge badge-success">{{ translate('Approved') }}</p>
                                            @endif

                                            @if ($earning->status == config('ecommerce.seller_earning_status.pending'))
                                                <p class="badge badge-warning">{{ translate('Pending') }}</p>
                                            @endif

                                            @if ($earning->status == config('ecommerce.seller_earning_status.refunded'))
