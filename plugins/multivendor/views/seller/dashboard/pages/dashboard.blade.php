...
@push('head')
    ...
    <link rel="stylesheet" href="{{ asset('web-assets/backend/plugins/apex/apexcharts.css') }}">
...
@section('custom_scripts')
    ...
    <script src="{{ asset('web-assets/backend/plugins/apex/apexcharts.min.js') }}"></script>
