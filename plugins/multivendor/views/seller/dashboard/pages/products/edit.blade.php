                                                ...
                                                @php
                                                    ...
                                                    foreach ($variant_array as $com_key => $variant) {
                                                        ...
                                                        if ($variant_com_array[0] === 'color') {
                                                            ...
                                                            $choice_name = \Plugin\Ecommerce\Models\Colors::find($variant_com_array[1])->translation('name');
                                                        } else {
                                                            $option_name = $attributes
                                                                ->where('id', $variant_com_array[0])
                                                                ->first()
                                                                ->translation('name', getLocale());
                                                            $choice_name = \Plugin\Ecommerce\Models\AttributeValues::find($variant_com_array[1])->name;
                                                        }
                                ...
                                <div class="col-sm-4">
                                    <select class="theme-input-style select2" name="discount_amount_type">
                                        ...
                                        <option value="{{ config('ecommerce.amount_type.percent') }}"
                                            @if ($product_details->discount_type == config('ecommerce.amount_type.percent')) selected @endif>
                        ...
                        @if (getEcommerceSetting('shipping_option') == null ||
                            ...
                            <div class="shipping-zone-list">
                                @if ($product_details->shippingProfile != null)
                                    @include(
                                        'plugin/multivendor::seller.dashboard.pages.products.shipping_zone',
