                    ...
                    <div class="main-header-left h-100 d-flex align-items-center">
                                        ...
                                        <div class="user-avatar">
                                            @if (auth()->user()->image != null)
                                                <img src="{{ asset(getFilePath(auth()->user()->image, true)) }}"
                                                    alt="{{ auth()->user()->name }}">
                                            @else
                                                <img src="{{ asset('web-assets/backend/img/avatar/user.png') }}"
                                                    alt="{{ auth()->user()->name }}">
                                            @endif
                                        </div>
                                        <!-- End User Avatar -->
                        ...
                        <div class="main-header-menu d-block d-lg-none">
                            <div class="header-toogle-menu">
                                <img src="{{ asset('web-assets/backend/img/menu.png') }}" alt="">
                            </div>
                        </div>
                            ...
                            <li class="ml-3">
                                ...
                                <div class="main-header-notification">
                                    <a href="/" target="_blank" title="Visit website"
                                        ...
                                        <img src="{{ asset('web-assets/backend/img/svg/globe-icon.svg') }}"
                                            alt="bell" class="svg">
                                    </a>
                                </div>
                                <!-- End Visit website -->
                                ...
                                <div class="main-header-notification">
                                    <a href="#" class="header-icon notification-icon" data-toggle="dropdown"
                                        ...
                                        @if (isset($active_lang->code))
                                            <img src="{{ asset('web-assets/backend/img/flags/') . '/' . $active_lang->code . '.png' }}"
                                    ...
                                    <div id="lang-change" class="dropdown-menu style--three">
                                        @foreach ($active_langs as $lang)
                                            <a href="#" class="dropdown-item" data-lan="{{ $lang->code }}">
                                                <img src="{{ asset('web-assets/backend/img/flags/') . '/' . $lang->code . '.png' }}"
                                ...
                                <div class="main-header-notification">
                                    <a href="#" class="header-icon notification-icon" data-toggle="dropdown"
                                        ...
                                        <span class="count notification-counter"
                                            data-bg-img="{{ asset('web-assets/backend/img/count-bg.png') }}">0</span>
                                        <img src="{{ asset('web-assets/backend/img/svg/notification-icon.svg') }}"
                                            alt="bell" class="svg">
                                    </a>
