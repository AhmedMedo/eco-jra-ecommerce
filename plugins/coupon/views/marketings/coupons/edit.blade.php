                                    ...
                                    <div class="col-sm-8">
                                        <select class="theme-input-style" name="discount_amount_type"
                                            ...
                                            <option value="{{ config('ecommerce.amount_type.flat') }}"
                                                @if ($coupon_details->discount_type == config('ecommerce.amount_type.flat')) selected @endif>
                                                {{ translate('Flat') }}</option>
                                            <option value="{{ config('ecommerce.amount_type.percent') }}"
                                                @if ($coupon_details->discount_type == config('ecommerce.amount_type.percent')) selected @endif>
