                            ...
                            @foreach ($deal_details->deal_products as $key => $deal_product)
                                @if ($deal_product->product != null)
                                    <tr>
                                        ...
                                        <td>
                                            {{ $deal_product->discount }}{{ $deal_product->discount_type == config('ecommerce.amount_type.percent') ? '%' : currencySymbol() }}
                                        </td>
                                        <td>
                                            <div class="dropdown-button">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    @if (isActivePlugin('ecommerce'))
                                                        <a href="{{ route('plugin.ecommerce.product.edit', ['id' => $deal_product->product->id, 'lang' => getDefaultLang()]) }}"
                                                            target="_blank">
                    ...
                    <div class="form-row mb-2">
                        ...
                        <div class="col-sm-12">
                            <select class="theme-input-style" name="discount_type">
                                <option value="{{ config('ecommerce.amount_type.flat') }}"> {{ translate('Flat') }}
                                </option>
        ...
        (function($) {
            ...
            $(document).ready(function() {
                $('.productSelect').select2({
                    ...
                    ajax: {
                        url: '{{ route('plugin.ecommerce.product.dropdown.options') }}',
                        dataType: 'json',
                        method: "GET",
                        delay: 250,
