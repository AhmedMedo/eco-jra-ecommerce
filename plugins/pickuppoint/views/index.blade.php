...
@section('custom_css')
    ...
    <link rel="stylesheet" href="{{ asset('web-assets/backend/plugins/data-table/css/jquery.dataTables.min.css') }}">
    <link rel="stylesheet"
    ...
    <link rel="stylesheet"
        href="{{ asset('web-assets/backend/plugins/datatables-buttons/css/buttons.bootstrap4.min.css') }}">
    <link rel="stylesheet" href="{{ asset('web-assets/backend/plugins/fontawsome/css/all.min.css') }}">
...
@section('custom_scripts')
    <script src="{{ asset('web-assets/backend/plugins/data-table/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('web-assets/backend/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js') }}">
    </script>
    <script src="{{ asset('web-assets/backend/plugins/datatables-responsive/js/dataTables.responsive.min.js') }}">
    </script>
    <script src="{{ asset('web-assets/backend/plugins/datatables-responsive/js/responsive.bootstrap4.min.js') }}">
    </script>

    <script src="{{ asset('web-assets/backend/plugins/datatables-buttons/js/dataTables.buttons.min.js') }}">
    </script>
    <script src="{{ asset('web-assets/backend/plugins/datatables-buttons/js/buttons.bootstrap4.min.js') }}">
    </script>
    <script src="{{ asset('web-assets/backend/plugins/jszip/jszip.min.js') }}"></script>
    <script src="{{ asset('web-assets/backend/plugins/pdfmake/pdfmake.min.js') }}"></script>
    <script src="{{ asset('web-assets/backend/plugins/pdfmake/vfs_fonts.js') }}"></script>
    <script src="{{ asset('web-assets/backend/plugins/datatables-buttons/js/buttons.html5.min.js') }}"></script>
    <script src="{{ asset('web-assets/backend/plugins/datatables-buttons/js/buttons.print.min.js') }}"></script>
    <script src="{{ asset('web-assets/backend/plugins/datatables-buttons/js/buttons.colVis.min.js') }}"></script>
    <script>
        (function($) {
            "use strict";
