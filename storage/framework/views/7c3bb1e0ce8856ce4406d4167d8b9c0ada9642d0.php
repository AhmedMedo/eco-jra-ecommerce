<!--Wallet Module-->
<?php if(auth()->user()->can('Manage Offline Payment Methods') ||
        auth()->user()->can('Manage Wallet Transactions')): ?>
    <li
        ...
        <a href="#">
            ...
            <span class="link-title"><?php echo e(translate('Wallet')); ?></span><span
...
<?php endif; ?>
<!--End Wallet Module-->
<?php /**PATH /home/medo/work/eco-jara/fashly/plugins/wallet/views/includes/navbar.blade.php ENDPATH**/ ?>