                    ...
                    <div class="main-header-left h-100 d-flex align-items-center">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <div class="main-header-user">
                                <a href="#" class="d-flex align-items-center" data-toggle="dropdown">
                                    ...
                                    <div class="user-profile d-lg-flex align-items-center d-none">
                                        ...
                                        <div class="user-avatar">
                                            ...
                                            <?php else: ?>
                                                <img src="<?php echo e(asset('web-assets/backend/img/avatar/user.png')); ?>"
                                                    alt="<?php echo e(auth()->user()->name); ?>">
                                            <?php endif; ?>
                                        </div>
                                        <!-- End User Avatar -->
                                ...
                                <div class="dropdown-menu">
                                    <a
                                        href="<?php echo e(route('plugin.multivendor.seller.profile.page')); ?>"><?php echo e(translate('My Profile')); ?></a>
                                    <a href="<?php echo e(route('plugin.multivendor.seller.logout')); ?>"><?php echo e(translate('Log Out')); ?></a>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="main-header-menu d-block d-lg-none">
                            <div class="header-toogle-menu">
                                <img src="<?php echo e(asset('web-assets/backend/img/menu.png')); ?>" alt="">
                            </div>
                        </div>
                            ...
                            <li class="ml-3">
                                ...
                                <div class="main-header-notification">
                                    <a href="/" target="_blank" title="Visit website"
                                        ...
                                        <img src="<?php echo e(asset('web-assets/backend/img/svg/globe-icon.svg')); ?>"
                                            alt="bell" class="svg">
                                    </a>
                                </div>
                                <!-- End Visit website -->
                                ...
                                <div class="main-header-notification">
                                    <a href="#" class="header-icon notification-icon" data-toggle="dropdown"
                                        ...
                                        <?php if(isset($active_lang->code)): ?>
                                            <img src="<?php echo e(asset('web-assets/backend/img/flags/') . '/' . $active_lang->code . '.png'); ?>"
                                    ...
                                    <div id="lang-change" class="dropdown-menu style--three">
                                        <?php $__currentLoopData = $active_langs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="#" class="dropdown-item" data-lan="<?php echo e($lang->code); ?>">
                                                <img src="<?php echo e(asset('web-assets/backend/img/flags/') . '/' . $lang->code . '.png'); ?>"
                                ...
                                <div class="main-header-notification">
                                    <a href="#" class="header-icon notification-icon" data-toggle="dropdown"
                                        ...
                                        <span class="count notification-counter"
                                            data-bg-img="<?php echo e(asset('web-assets/backend/img/count-bg.png')); ?>">0</span>
                                        <img src="<?php echo e(asset('web-assets/backend/img/svg/notification-icon.svg')); ?>"
                                            alt="bell" class="svg">
                                    </a>
...
<?php /**PATH /home/medo/work/eco-jara/fashly/plugins/multivendor/views/seller/dashboard/layouts/seller_header.blade.php ENDPATH**/ ?>