                        ...
                        <form action="<?php echo e(route('core.attemptLogin')); ?>" method="post">
                            ...
                            <div class="form-group mb-20">
                                ...
                                <?php if($errors->has('email')): ?>
                                    <div class="text-danger mt-2 font-12"><?php echo e($errors->first('email')); ?></div>
                                <?php endif; ?>
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div class="form-group mb-20">
                                ...
                                <?php if($errors->has('password')): ?>
                                    <div class="text-danger mt-2 font-12"><?php echo e($errors->first('password')); ?></div>
                                <?php endif; ?>
                            </div>
                            <!-- End Form Group -->
                            <div class="form-row justify-content-between mb-20">
                                <a href="<?php echo e(route('core.password.reset.link')); ?>"
                                    class="font-12 text_color"><?php echo e(translate('Forgot Password?')); ?>
...
<?php echo $__env->make('core::base.auth.auth_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/medo/work/eco-jara/fashly/Core/resources/views/base/auth/login.blade.php ENDPATH**/ ?>