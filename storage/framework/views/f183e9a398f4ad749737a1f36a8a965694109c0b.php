...
<?php $__env->startSection('builder-css-link'); ?>
    <?php if(isActivePlugin('pagebuilder') && isset($page) && $page->page_type == 'builder'): ?>
        <?php
            $active_theme = getActiveTheme();
            $builder_css_file = base_path("themes/{$active_theme->location}builder-assets/css/{$page->permalink}.css");
            $builder_css_path = asset("themes/{$active_theme->location}builder-assets/css/{$page->permalink}.css");
        ?>
...
<?php echo $__env->make('theme/fashion-theme::frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/medo/work/eco-jara/fashly/themes/fashion-theme/resources/views/frontend/pages/home.blade.php ENDPATH**/ ?>