...
<?php $__env->startPush('head'); ?>
    ...
    <link href="<?php echo e(asset('web-assets/backend/css/ratings.css')); ?>" rel="stylesheet" />
    <style>
        .overflow-text {
            display: block;
            display: -webkit-box;
...
<div class="card mb-30">
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        <h4><?php echo e(__('Business Insight')); ?></h4>
        <div class="section-box">
            <select class="form-control" id="business_insight_change">
                <option value="over_all"><?php echo e(translate('Overall statistics')); ?></option>
                <option value="today"><?php echo e(translate('Todays Statistics')); ?></option>
                <option value="month"><?php echo e(translate('This Months Statistics')); ?></option>
            </select>
        </div>
    </div>
    <div class="card-body">
                    ...
                    <div class="state">
                        <div class="d-flex justify-content-between px-2">
                            <div class="state-content">
                                <p class="font-14 mb-2 bold black"><?php echo e(translate('Total Customers')); ?></p>
                                <h3 class="total_customer"><?php echo e($business_stats['total_customers']); ?></h3>
                            </div>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card custom-card mb-20">
                    <div class="state">
                        <div class="d-flex justify-content-between px-2">
                            <div class="state-content ">
                                <p class="font-14 mb-2 bold black"><?php echo e(translate('Total Orders')); ?></p>
                                <h3 class="total_orders">
                                    <?php echo e($business_stats['total_orders']); ?>
                    ...
                    <div class="state">
                        <div class="d-flex justify-content-between px-2">
                            <div class="state-content bold black">
                                <p class="font-14 mb-2"><?php echo e(translate('Total Products')); ?></p>
                                <h3 class="total_products"><?php echo e($business_stats['total_products']); ?></h3>
                            </div>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card custom-card mb-20">
                    <div class="state">
                        <div class="d-flex justify-content-between px-2">
                            <div class="state-content">
                                <p class="font-14 mb-2 black bold"><?php echo e(translate('Total Sales')); ?></p>
                                <h3 class="total_sales"><?php echo e($business_stats['total_sales']); ?></h3>
                            </div>
                    ...
                    <div class="card-body p-2 px-3">
                        <div class="align-items-center  d-flex justify-content-between  order-couter-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="content">
                                    <h5><?php echo e(translate('Pending')); ?></h5>
                                </div>
                            </div>
                            <div class="">
                                <h5 class="pending_orders">
                                    <?php echo e($business_stats['pending_orders']); ?>
                    ...
                    <div class="card-body p-2 px-3">
                        <div class="align-items-center  d-flex justify-content-between  order-couter-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="content">
                                    <h5><?php echo e(translate('Approved')); ?></h5>
                                </div>
                            </div>
                            <div class="">
                                <h5 class="approved">
                                    <?php echo e($business_stats['approved']); ?>
                    ...
                    <div class="card-body p-2 px-3">
                        <div class="align-items-center  d-flex justify-content-between  order-couter-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="content">
                                    <h5><?php echo e(translate('Ready to Ship')); ?></h5>
                                </div>
                            </div>
                            <div class="">
                                <h5 class="ready_to_ship">
                                    <?php echo e($business_stats['ready_to_ship']); ?>
                    ...
                    <div class="card-body p-2 px-3">
                        <div class="align-items-center  d-flex justify-content-between  order-couter-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="content">
                                    <h5><?php echo e(translate('Shipped')); ?></h5>
                                </div>
                            </div>
                            <div class="">
                                <h5 class="shipped-order">
                                    <?php echo e($business_stats['shipped']); ?>
                    ...
                    <div class="card-body p-2 px-3">
                        <div class="align-items-center  d-flex justify-content-between  order-couter-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="content">
                                    <h5><?php echo e(translate('Delivered')); ?></h5>
                                </div>
                            </div>
                            <div class="">
                                <h5 class="delivered-order">
                                    <?php echo e($business_stats['delivered']); ?>
                    ...
                    <div class="card-body p-2 px-3">
                        <div class="align-items-center  d-flex justify-content-between  order-couter-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="content">
                                    <h5><?php echo e(translate('Cancelled')); ?></h5>
                                </div>
                            </div>
                            <div class="">
                                <h5 class="cancelled-order">
                                    <?php echo e($business_stats['cancelled']); ?>
                    ...
                    <div class="card-body p-2 px-3">
                        <div class="align-items-center  d-flex justify-content-between  order-couter-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="content">
                                    <h5><?php echo e(translate('Returned')); ?></h5>
                                </div>
                            </div>
                            <h5 class="total_refunds">
                                <?php echo e($business_stats['total_refunds']); ?>
                    ...
                    <div class="card-body p-2 px-3">
                        <div class="align-items-center  d-flex justify-content-between  order-couter-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="content">
                                    <h5><?php echo e(translate('Refund Processing')); ?></h5>
                                </div>
                            </div>
                            <h5 class="return_processing">
                                <?php echo e($business_stats['return_processing']); ?>
        ...
        <div class="card mb-30">
            <div
                ...
                <div class="title-content mb-4 mr-sm-5 mb-sm-0">
                    <h4 class=""><?php echo e(translate('Sale Reports')); ?></h4>
                </div>
                <!-- List Button -->
                <ul class="list-inline list-button m-0 mr-5">
                    <li class="active chart-switcher rounded" data-type="monthly"><?php echo e(translate('Last 12 Months')); ?>

                    </li>
                    <li class="chart-switcher rounded" data-type="daily"><?php echo e(translate('Last 30 Days')); ?></li>
                </ul>
                <!-- End List Button -->
            </div>
            <div class="card-body">
    ...
    <div class="col-xl-8 col-lg-7 col-12">
        ...
        <div class="card fixed-card mb-30">
            <div class="card-header py-3 bg-white">
                <h4><?php echo e(translate('Recent Orders')); ?></h4>
            </div>
                            ...
                            <?php if($recent_orders->count() > 0): ?>
                                <?php $__currentLoopData = $recent_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <a
                                                href="<?php echo e(route('plugin.ecommerce.orders.details', ['id' => $order->id])); ?>"><?php echo e($order->order_code); ?></a>
                                        </td>
                                        <td><?php echo e($order->created_at->format('d M Y h:i A')); ?></td>
                                        <td>
                                            <?php if($order->customer_info != null): ?>
                                                <a
                                                    href="<?php echo e(route('plugin.ecommerce.customers.details', ['id' => $order->customer_id])); ?>"><?php echo e($order->customer_info->name); ?></a>
                                            <?php else: ?>
                                                <a href="#"><?php echo e($order->guest_customer->name); ?><span
                                                        class="badge badge-info ml-1">Guest</span></a>
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo currencyExchange($order->total_payable_amount); ?></td>
                                        <td>
                                            <a href="<?php echo e(route('plugin.ecommerce.orders.details', ['id' => $order->id])); ?>"
                                                class="details-btn">
                                                Details
    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card fixed-card mb-20">
            <div class="card-header bg-white py-3">
                <h4><?php echo e(translate('Top Customers')); ?></h4>
            </div>
            <div class="card-body">
                <div class="product-list">
                    <?php if($top_customers->count() > 0): ?>
                        <?php $__currentLoopData = $top_customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="img mr-3">
                                        <img src="<?php echo e(asset(getFilePath($customer->image, true))); ?>"
                                            alt="<?php echo e($customer->name); ?>">
                                    </div>
                                    <div class="content">
                                        <a href="<?php echo e(route('plugin.ecommerce.customers.details', ['id' => $customer->id])); ?>"
                                            class="black mb-1"><?php echo e($customer->name); ?>

                                        </a>
                                        <p class="bold font-14">
                                            <?php echo currencyExchange($customer->orders->sum('total_payable_amount')); ?></p>
                                    </div>
                                </div>
                                <p class="bold  font-14 text-center"><?php echo e($customer->orders_count); ?><br>
                                    <?php echo e($customer->orders_count > 1 ? 'Orders' : 'Order'); ?></p>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                        <p class="alert alert-danger text-center"><?php echo e(translate('Nothing Found')); ?></p>
...
<div class="row">
    ...
    <div class="col-xl-4 col-lg-6">
        <div class="card fixed-card mb-30">
            <div class="card-header bg-white py-3">
                <h4><?php echo e(translate('Popular Products')); ?></h4>
            </div>
            <div class="card-body">
                <div class="product-list">
                    <?php if($popular_products->count() > 0): ?>
                        <?php $__currentLoopData = $popular_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="img mr-3">
                                        <img src="<?php echo e(asset(getFilePath($product->thumbnail_image, true))); ?>"
                                            alt="<?php echo e($product->translation('name', getLocale())); ?>"
                                            class="dash-image">
                                    </div>
                                    <div class="content">
                                        <p class="black mb-1 overflow-text text-capitalize">
                                            <?php echo e($product->translation('name', getLocale())); ?></p>
                                        
                                        <div class="product-rating-wrapper">
                                            <i data-star="<?php echo e($product->reviews_avg_rating); ?>"
                                                title="<?php echo e($product->reviews_avg_rating); ?>"></i>
                                        </div>
                                    </div>
                                </div>
                                <p class="bold  font-14 text-center">
                                    <?php echo e($product->reviews_count != null ? $product->reviews_count : 0); ?><br>
                                    <?php echo e($product->reviews_count > 1 ? 'Reviews' : 'Review'); ?>
    ...
    <div class="col-xl-4 col-lg-6">
        <div class="card fixed-card mb-30">
            <div class="card-header bg-white py-3">
                <h4><?php echo e(translate('Top Selling Products')); ?></h4>
            </div>
            <div class="card-body">
                <div class="product-list">
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="content">
                                        <p class="black mb-1 overflow-text text-capitalize">
                                            <?php echo e($product->translation('name', getLocale())); ?></p>
                                        <span class="bold font-14"><?php echo currencyExchange($product->orders_sum_unit_price * $product->orders_sum_quantity); ?></span>
                                    </div>
                                </div>
                                <p class="bold  font-14 text-center">
                                    <?php echo e($product->orders_count != null ? $product->orders_count : 0); ?><br>
                                    <?php echo e($product->orders_count > 1 ? 'Sales' : 'Sale'); ?>
    ...
    <!--Top selling shop-->
    <?php if(isActivePlugin('multivendor')): ?>
        <div class="col-xl-4 col-lg-6">
            <div class="card fixed-card mb-30">
                <div class="card-header bg-white py-3">
                    <h4><?php echo e(translate('Top Selling Store')); ?></h4>
                </div>
                <div class="card-body">
                    <div class="product-list">
                        <?php if($top_selling_stores->count() > 0): ?>
                            <?php $__currentLoopData = $top_selling_stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    class="product-list-item mb-20 d-flex justify-content-between align-items-center gap-15">
                                    <div class="d-flex align-items-center">
                                        <div class="img mr-3">
                                            <img src="<?php echo e(asset(getFilePath($shop['logo'], true))); ?>"
                                                alt="<?php echo e($shop['shop_name']); ?>">
                                        </div>
                                        <div class="content">
                                            <p class="black mb-1"><?php echo e($shop['shop_name']); ?></p>
                                            <span class=" bold font-14"><?php echo currencyExchange($shop['orders_sum_unit_price']); ?></span>
                                        </div>
                                    </div>
                                    <p class="bold  font-14 text-center">
                                        <?php echo e($shop['orders_count'] != null ? $shop['orders_count'] : 0); ?><br>
                                        <?php echo e($shop['orders_count'] > 1 ? 'Sales' : 'Sale'); ?></p>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <p class="alert alert-danger text-center"><?php echo e(translate('Nothing Found')); ?></p>
        ...
        <div class="col-xl-4 col-lg-6">
            <div class="card fixed-card mb-30">
                <div class="card-header bg-white py-3">
                    <h4><?php echo e(translate(' Popular Stores')); ?></h4>
                </div>
                <div class="card-body">
                    <div class="product-list">
                        <?php if($popular_stores->count() > 0): ?>
                            <?php $__currentLoopData = $popular_stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    class="product-list-item mb-20 d-flex justify-content-between align-items-center gap-15">
                                    <div class="d-flex align-items-center">
                                        <div class="img mr-3">
                                    ...
                                    <p class="bold  font-14 text-center">
                                        <?php echo e($shop['followers_count'] != null ? $shop['followers_count'] : 0); ?><br>
                                        <?php echo e($shop['followers_count'] > 1 ? 'Followers' : 'Follower'); ?></p>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <p class="alert alert-danger text-center"><?php echo e(translate('Nothing Found')); ?></p>
    ...
    <div class="col-xl-4 col-lg-6">
        <div class="card fixed-card mb-30">
            <div class="card-header bg-white py-3">
                <h4><?php echo e(translate('Top Categories')); ?></h4>
            </div>
            <div class="card-body">
                <div class="product-list">
                    <?php if($top_categories->count() > 0): ?>
                        <?php $__currentLoopData = $top_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="img mr-3">
                                        <img src="<?php echo e(asset(getFilePath($category['icon'], true))); ?>"
                                            alt="<?php echo e($category['name']); ?>">
                                    </div>
                                    <div class="content">
                                        <p class="black mb-1"><?php echo e($category['name']); ?></p>
                                        <span class=" bold font-14"><?php echo currencyExchange($category['total_sales']); ?></span>
                                    </div>
                                </div>
                                <p class="bold  font-14 text-center">
                                    <?php echo e($category['number_of_sales'] != null ? $category['number_of_sales'] : 0); ?><br>
                                    <?php echo e($category['number_of_sales'] > 1 ? 'Sales' : 'Sale'); ?></p>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                        <p class="alert alert-danger text-center"><?php echo e(translate('Nothing Found')); ?></p>
    ...
    <div class="col-xl-4 col-lg-6">
        <div class="card fixed-card mb-30">
            <div class="card-header bg-white py-3">
                <h4><?php echo e(translate('Top Brands')); ?></h4>
            </div>
            <div class="card-body">
                <div class="product-list">
                    <?php if($top_brands->count() > 0): ?>
                        <?php $__currentLoopData = $top_brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="img mr-3">
                                        <img src="<?php echo e(asset(getFilePath($brand['logo'], true))); ?>"
                                            alt="<?php echo e($brand['name']); ?>" class="img-20">
                                    </div>
                                    <div class="content">
                                        <p class="black mb-1"><?php echo e($brand['name']); ?></p>
                                        <span class="bold font-14"><?php echo currencyExchange($brand['total_sales']); ?></span>
                                    </div>
                                </div>
                                <p class="bold  font-14 text-center">
                                    <?php echo e($brand['number_of_sales'] != null ? $brand['number_of_sales'] : 0); ?><br>
                                    <?php echo e($brand['number_of_sales'] > 1 ? 'Sales' : 'Sale'); ?></p>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                        <p class="alert alert-danger text-center"><?php echo e(translate('Nothing Found')); ?></p>
        ...
        (function($) {
            ...
            $("#business_insight_change").on('change', function(e) {
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(route('plugin.ecommerce.business.stats')); ?>',
            ...
            function getChartData() {
                $.ajax({
                    ...
                    url: '<?php echo e(route('plugin.ecommerce.reports.sales.chart')); ?>',
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/medo/work/eco-jara/fashly/plugins/ecommerce/views/includes/dashboard.blade.php ENDPATH**/ ?>