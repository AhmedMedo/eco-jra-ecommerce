...
<?php $__env->startSection('custom_css'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/themes/fashion-themeblog/css/font-awesome.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('/themes/fashion-themeblog/dist/css/fontawesome-iconpicker.min.css')); ?>">
...
<?php $__env->startSection('main_content'); ?>
    ...
    <div class="border-bottom2 pb-3 mb-4">
        <h4><i class="icofont-options"></i><?php echo e(translate('Theme Options')); ?></h4>
    </div>
    <div class="theme-option-container">
        <form action="<?php echo e(route('theme.fashion-theme.save.option.form')); ?>" method="post" enctype="multipart/form-data"
            id="themeOptionForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="theme-option-tab-wrap">
                <div class="nav flex-column py-3 px-2 theme-option-sidebar" aria-orientation="vertical">
                    <?php if ($__env->exists('theme/fashion-theme::backend.theme.option_sidebar')) echo $__env->make('theme/fashion-theme::backend.theme.option_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>

                <div class="form border-left2">
                    <div id="loader" class="d-none">
                        <img src="<?php echo e(asset('loader.svg')); ?>" alt="" width="80px" height="auto">
                    </div>
                    <div class="card">
...
<?php $__env->startSection('custom_scripts'); ?>
    ...
    <script src="<?php echo e(asset('web-assets/backend/plugins/jquery-ui/jquery-ui.js')); ?>"></script>

    
    <script src="<?php echo e(asset('/themes/fashion-themeblog/dist/js/fontawesome-iconpicker.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('web-assets/backend/plugins/js-cookie/js.cookie.min.js')); ?>"></script>
    ...
    <script  type="application/javascript">
        ...
        function getOptionForm(id){
            ...
            $.ajax({
                type: "post",
                url: '<?php echo e(route('theme.fashion-theme.get.option.form')); ?>',
                data: {
                    id: id
                },
            ...
            <div class="accordion-item my-2">
                <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button bg-transparent">
                        <?php echo e(translate('New Social Link')); ?>
...
<?php echo $__env->make('core::base.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/medo/work/eco-jara/fashly/themes/fashion-theme/resources/views/backend/theme/options.blade.php ENDPATH**/ ?>