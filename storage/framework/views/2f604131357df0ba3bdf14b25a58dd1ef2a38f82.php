<?php
    ...
    $recent_orders_query = \Plugin\Ecommerce\Models\Orders::with([
        'customer_info',
        'guest_customer',
    ...
    $top_products = \Plugin\Ecommerce\Models\Product::select(['id', 'name', 'permalink', 'thumbnail_image'])
...
<?php $__env->startSection('seller_main_content'); ?>
    <!--Business Stats-->
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card custom-card mb-20">
                        <div class="state">
                            <div class="d-flex justify-content-between px-2">
                                <div class="state-content bold black">
                                    <p class="font-14 mb-2"><?php echo e(translate('Total Eerning')); ?></p>
                                    <h3 class="total_earning"><?php echo e($business_stats['total_earning']); ?></h3>
                                </div>
    ...
    <div class="row">
                        ...
                        <table class="style--three table-centered text-nowrap">
                            ...
                            <tbody>
                                <?php if($recent_orders->count() > 0): ?>
                                    <?php $__currentLoopData = $recent_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <a
                                                    href="<?php echo e(route('plugin.multivendor.seller.dashboard.order.details', ['id' => $order->id])); ?>"><?php echo e($order->order_code); ?></a>
                                            </td>
                                            <td><?php echo e($order->created_at->format('d M Y h:i A')); ?></td>
                                            <td>
                                                <?php if($order->customer_info != null): ?>
                                                    <p><?php echo e($order->customer_info->name); ?></p>
                                                <?php else: ?>
                                                    <p><?php echo e($order->guest_customer->name); ?>

                                                        <span
                                                            class="badge badge-info ml-1"><?php echo e(translate('Guest')); ?></span>
                                                    </p>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                ...
                                                ?>
                                                <?php echo currencyExchange($total_payable_amount); ?>

                                            </td>
                                            <td>
                                                <a href="<?php echo e(route('plugin.multivendor.seller.dashboard.order.details', ['id' => $order->id])); ?>"
                                                    class="details-btn">
                                                    Details
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="5">
                                            <p class="alert alert-danger text-center"><?php echo e(translate('No Items Found')); ?>
        ...
        <div class="col-xl-4 col-lg-6">
            ...
            <div class="card fixed-card mb-20">
                <div class="card-header bg-white py-3">
                    <h4><?php echo e(translate('Top Products')); ?></h4>
                </div>
                <div class="card-body pb-2">
                    <div class="product-list">
                        <?php if($top_products->count() > 0): ?>
                            <?php $__currentLoopData = $top_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="product-list-item mb-3 d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="bold  font-14 text-center">
                                        <?php echo e($product->orders_count != null ? $product->orders_count : 0); ?>

                                        <?php echo e($product->orders_count > 1 ? 'Sales' : 'Sale'); ?></p>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <p class="alert alert-danger text-center"><?php echo e(translate('No Items Found')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        (function($) {
            ...
            $("#business_insight_change").on('change', function(e) {
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(route('plugin.multivendor.seller.business.stats')); ?>',
            ...
            function getChartData() {
                $.ajax({
                    ...
                    url: '<?php echo e(route('plugin.multivendor.seller.reports.sales.chart')); ?>',
...
<?php echo $__env->make('plugin/multivendor::seller.dashboard.layouts.seller_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/medo/work/eco-jara/fashly/plugins/multivendor/views/seller/dashboard/pages/dashboard.blade.php ENDPATH**/ ?>